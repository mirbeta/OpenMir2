...
namespace LoginSvr
{
    public class LoginSvrService
    {
        ...
        public LoginSvrService(AccountDB accountDB, MasSocService masSock)
        {
        ...
        private void AccountChangePassword(TConfig Config, TUserInfo UserInfo, string sData)
        {
            ...
            try
            {
                sMsg = EDcode.DeCodeString(sData);
                sMsg = HUtil32.GetValidStr3(sMsg, ref sLoginID, new string[] { "\09" });
                sNewPassword = HUtil32.GetValidStr3(sMsg, ref sOldPassword, new string[] { "\09" });
                nCode = 0;
                try
                {
