        ...
        public override void Run()
        {
            ...
            if (this.m_nCurrentAction != 0)
            {
                ...
                if (MShare.GetTickCount() - this.m_dwStartTime > m_dwFrameTimetime)
                {
                    ...
                    {
                        meff = ((TFlyingBug)(ClMain.g_PlayScene.NewFlyObject(this, this.m_nCurrX, this.m_nCurrY, this.m_nTargetX, this.m_nTargetY, this.m_nTargetRecog, magiceff.TMagicType.mtFireBall)));
                        if (meff != null)
                        {
