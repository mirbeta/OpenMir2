...
public static class HttpExtensions
{
    ...
    {
        using (FileStorageReader reader = FilePool.GetReader(filePath))
        {
            response.SetContentTypeByExtension(Path.GetExtension(filePath));
            string contentDisposition = "attachment;" + "filename=" + System.Web.HttpUtility.UrlEncode(fileName == null ? Path.GetFileName(filePath) : fileName);
    ...
    {
        string contentDisposition = "attachment;" + "filename=" + System.Web.HttpUtility.UrlEncode(fileName);
        response.SetHeader(HttpHeaders.ContentDisposition, contentDisposition);
        return response;
    }
