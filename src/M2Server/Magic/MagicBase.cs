...
namespace M2Server.Magic
{
    public static class MagicBase
    {
        ...
        public static bool CheckAmulet(PlayObject playObject, byte nCount, byte nType, ref short Idx)
        {
            ...
            {
                amuletStdItem = SystemShare.EquipmentSystem.GetStdItem(playObject.UseItems[ItemLocation.ArmRingl].Index);
            ...
            {
                amuletStdItem = SystemShare.EquipmentSystem.GetStdItem(playObject.UseItems[ItemLocation.Bujuk].Index);
                if (amuletStdItem != null && amuletStdItem.StdMode == 25)
                {
                    switch (nType)
                    {
