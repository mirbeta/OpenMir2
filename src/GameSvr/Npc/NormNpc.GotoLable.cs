...
namespace GameSvr.Npc
{
    public partial class NormNpc
    {
        ...
        private ClientUserItem CheckGotoLableItemW(PlayObject PlayObject, string sItemType, int nParam)
        {
        ...
        private bool GotoLable_QuestCheckCondition_CheckUserDateType(PlayObject PlayObject, string ChrName, string sListFileName, string sDay, string param1, string param2)
        {
            ...
            try
            {
                ...
                for (var i = 0; i < LoadList.Count; i++)
                {
                    ...
                    sText = HUtil32.GetValidStrCap(sText, ref Name, new char[] { ' ', '\t' });
                    Name = Name.Trim();
                    if (ChrName == Name)
                    {
        ...
        private bool GotoLableQuestCheckCondition(PlayObject PlayObject, IList<QuestConditionInfo> ConditionList, ref string sC, ref ClientUserItem UserItem)
        {
            bool result = true;
            int n1C = 0;
            int nMaxDura = 0;
        ...
        private void GotoLable_AddUseDateList(string sHumName, string sListFileName)
        {
            ...
            for (var i = 0; i < LoadList.Count; i++)
            {
                ...
                sText = HUtil32.GetValidStrCap(sText, ref s10, new char[] { ' ', '\t' });
        ...
        private bool GotoLableQuestActionProcess(PlayObject PlayObject, IList<QuestActionInfo> ActionList, ref string sC, ref ClientUserItem UserItem, ref bool bo11)
        {
            bool result = true;
            int n28;
            int n2C;
