    ...
    public partial class BaseObject
    {
        ...
        public void SendRefMsg(int wIdent, int wParam, int nParam1, int nParam2, int nParam3, string sMsg)
        {
            ...
            if (((HUtil32.GetTickCount() - SendRefMsgTick) >= 500) || (VisibleHumanList.Count == 0))
            {
                ...
                short nLx = (short)(CurrX - ModuleShare.Config.SendRefMsgRange); // 12
                short nHx = (short)(CurrX + ModuleShare.Config.SendRefMsgRange); // 12
                short nLy = (short)(CurrY - ModuleShare.Config.SendRefMsgRange); // 12
                short nHy = (short)(CurrY + ModuleShare.Config.SendRefMsgRange); // 12
