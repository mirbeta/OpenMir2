...
namespace BotSvr.Maps
{
    public class TMap : TPathMap
    {
        ...
        public void LoadMapData(bool bFirst = false)
        {
            ...
            if (m_nCurrentMap != null)
            {
                ...
                if (m_MapBuf != null)
                {
                    ...
                    {
                        m_MapData = new TCellParams[m_MapHeader.wWidth, m_MapHeader.wHeight];
                    }
        ...
        {
            var result = false;
            if ((MShare.g_MySelf != null) && (m_nCurrentMap != null) && (m_MapBuf != null))
            {
        ...
        private void LoadMapArr(int nCurrX, int nCurrY)
        {
            ...
            if (m_nCurrentMap != null)
            {
                ...
                {
                    case 6:
                        nAline = TMapInfo.PacketSize * m_MapHeader.wHeight;
        ...
        public void LoadMap(string sMapName, int nMx, int nMy)
        {
            ...
            if (File.Exists(sFileName))
            {
                ...
                if (m_nCurrentMap != null)
                {
                    ...
                    m_MapHeader = new TMapHeader(headerData);
