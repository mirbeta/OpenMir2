        ...
        public void SearchMaster(PlayObject PlayObject)
        {
            ...
            if (PlayObject.m_boMaster)
            {
                ...
                for (var i = 0; i < PlayObject.m_MasterList.Count; i++)
                {
                    ...
                    PlayObject.SysMsg(Human.CharName + " " + Human.Envir.MapDesc + "(" + Human.CurrX + ":" + Human.CurrY + ")", MsgColor.Green, MsgType.Hint);
                    Human.SysMsg(M2Share.g_sYourMasterSearchLocateMsg, MsgColor.Green, MsgType.Hint);
                    Human.SysMsg(PlayObject.CharName + " " + PlayObject.Envir.MapDesc + "(" + PlayObject.CurrX + ":" + PlayObject.CurrY + ")", MsgColor.Green, MsgType.Hint);
                }
            }
            else
            {
                ...
                PlayObject.SysMsg(PlayObject.m_MasterHuman.CharName + " " + PlayObject.m_MasterHuman.Envir.MapDesc + "(" + PlayObject.m_MasterHuman.CurrX + ":"
                ...
                PlayObject.m_MasterHuman.SysMsg(PlayObject.CharName + " " + PlayObject.Envir.MapDesc + "(" + PlayObject.CurrX + ":" + PlayObject.CurrY + ")",
