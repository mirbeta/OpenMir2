...
namespace GameSvr
{
    ...
    {
        private readonly TGateInfo GateInfo = null;
        private readonly object m_RunSocketSection = null;

        public GameGate(TGateInfo gateInfo)
        {
            GateInfo = gateInfo;
            m_RunSocketSection = new object();
        }

        public void ExecGateBuffers(int nGateIndex, TGateInfo GameGate, byte[] data, int nMsgLen)
        {
