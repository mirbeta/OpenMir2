...
namespace GameSvr.Npc
{
    public partial class NormNpc
    {
        private bool ConditionOfCheckAccountIPList(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKACCOUNTIPLIST);
            }
            return result;
        }
        ...
        private bool ConditionOfCheckBagSize(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKBAGSIZE);
                return result;
            }
        ...
        private bool ConditionOfCheckHP(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if ((nMin < 0) || (nMax < 0))
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKHP);
                return result;
            }
            switch (cMethodMin)
            {
        ...
        private bool ConditionOfCheckMP(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if ((nMin < 0) || (nMax < 0))
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKMP);
                return result;
            }
            switch (cMethodMin)
            {
        ...
        private bool ConditionOfCheckDC(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if ((nMin < 0) || (nMax < 0))
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKDC);
                return result;
            }
            switch (cMethodMin)
            {
        ...
        private bool ConditionOfCheckMC(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if ((nMin < 0) || (nMax < 0))
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKMC);
                return result;
            }
            switch (cMethodMin)
            {
        ...
        private bool ConditionOfCheckSC(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if ((nMin < 0) || (nMax < 0))
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKSC);
                return result;
            }
            switch (cMethodMin)
            {
        ...
        private bool ConditionOfCheckExp(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (dwExp == 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKEXP);
                return result;
            }
            var cMethod = QuestConditionInfo.sParam1[0];
            switch (cMethod)
        ...
        private bool ConditionOfCheckFlourishPoint(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nPoint < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKFLOURISHPOINT);
                return false;
            }
        ...
        private bool ConditionOfCheckGuildAuraePoint(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nPoint < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKAURAEPOINT);
                return false;
            }
            if (PlayObject.m_MyGuild == null)
            {
        ...
        private bool ConditionOfCheckGuildBuildPoint(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nPoint < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKBUILDPOINT);
                return false;
            }
            if (PlayObject.m_MyGuild == null)
            {
        ...
        private bool ConditionOfCheckStabilityPoint(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nPoint < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKSTABILITYPOINT);
                return result;
            }
            if (PlayObject.m_MyGuild == null)
            {
        ...
        private bool ConditionOfCheckGameGold(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nGameGold < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKGAMEGOLD);
                return result;
            }
            var cMethod = QuestConditionInfo.sParam1[0];
            switch (cMethod)
        ...
        private bool ConditionOfCheckGamePoint(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nGamePoint < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKGAMEPOINT);
                return result;
            }
            var cMethod = QuestConditionInfo.sParam1[0];
            switch (cMethod)
        ...
        private bool ConditionOfCheckGroupCount(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nCount < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKGROUPCOUNT);
                return false;
            }
            var cMethod = QuestConditionInfo.sParam1[0];
            switch (cMethod)
        ...
        private bool ConditionOfIsHigh(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_ISHIGH);
                return false;
            }
        ...
        private bool ConditionOfCheckInMapRange(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKINMAPRANGE);
                return false;
            }
        ...
        private bool ConditionOfCheckIsAttackGuild(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_ISATTACKGUILD);
                return false;
            }
            if (PlayObject.m_MyGuild == null)
            {
        ...
        private bool ConditionOfCheckCastleChageDay(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CASTLECHANGEDAY);
                return result;
            }
        ...
        private bool ConditionOfCheckCastleWarDay(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if ((nDay < 0) || (this.m_Castle == null))
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CASTLEWARDAY);
                return false;
            }
        ...
        private bool ConditionOfCheckCastleDoorStatus(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKCASTLEDOOR);
                return result;
            }
        ...
        private bool ConditionOfCheckIsAttackAllyGuild(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            if (this.m_Castle == null)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_ISATTACKALLYGUILD);
                return false;
            }
            if (PlayObject.m_MyGuild == null)
            {
        ...
        private bool ConditionOfCheckIsDefenseAllyGuild(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            if (this.m_Castle == null)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_ISDEFENSEALLYGUILD);
                return false;
            }
            if (PlayObject.m_MyGuild == null)
            {
        ...
        private bool ConditionOfCheckIsDefenseGuild(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            if (this.m_Castle == null)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_ISDEFENSEGUILD);
                return false;
            }
            if (PlayObject.m_MyGuild == null)
            {
        ...
        private bool ConditionOfCheckItemAddValue(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKITEMADDVALUE);
                return result;
            }
        ...
        private bool ConditionOfCheckItemType(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKITEMTYPE);
                return result;
            }
            var UserItem = PlayObject.m_UseItems[nWhere];
        ...
        private bool ConditionOfCheckLevelEx(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nLevel < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKLEVELEX);
                return result;
            }
            var cMethod = QuestConditionInfo.sParam1[0];
            switch (cMethod)
        ...
        private bool ConditionOfCheckNameListPostion(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKNAMELISTPOSITION);
            }
        ...
        private bool ConditionOfCheckMarryCount(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nCount < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKMARRYCOUNT);
                return result;
            }
            var cMethod = QuestConditionInfo.sParam1[0];
            switch (cMethod)
        ...
        private bool ConditionOfCheckMemBerLevel(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nLevel < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKMEMBERLEVEL);
                return result;
            }
            var cMethod = QuestConditionInfo.sParam1[0];
            switch (cMethod)
        ...
        private bool ConditionOfCheckMemberType(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nType < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKMEMBERTYPE);
                return result;
            }
            var cMethod = QuestConditionInfo.sParam1[0];
            switch (cMethod)
        ...
        private bool ConditionOfCheckNameIPList(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKNAMEIPLIST);
            }
            return result;
        }
        ...
        private bool ConditionOfCheckPoseLevel(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nLevel < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKPOSELEVEL);
                return result;
            }
            var cMethod = QuestConditionInfo.sParam1[0];
            var PoseHuman = PlayObject.GetPoseCreate();
        ...
        private bool ConditionOfCheckSlaveCount(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nCount < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKSLAVECOUNT);
                return result;
            }
        ...
        private bool ConditionOfCheckGroupClass(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nJob < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHANGEJOB);
                return result;
            }
            if (PlayObject.m_GroupOwner != null)
            {
        ...
        private bool ConditionOfCheckRangeMonCount(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKRANGEMONCOUNT);
                return result;
            }
        ...
        private bool ConditionOfCheckUseItem(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if ((nWhere < 0) || (nWhere > PlayObject.m_UseItems.Length))
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKUSEITEM);
                return result;
            }
        ...
        private bool ConditionOfCheckVar(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKVAR);
                return result;
            }
        ...
        private bool ConditionOfCheckCastleGold(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKCASTLEGOLD);
                return result;
            }
            var cMethod = QuestConditionInfo.sParam1[0];
            switch (cMethod)
        ...
        private bool ConditionOfCheckContribution(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nContribution < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKCONTRIBUTION);
                return result;
            }
            var cMethod = QuestConditionInfo.sParam1[0];
            switch (cMethod)
        ...
        private bool ConditionOfCheckCreditPoint(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nCreditPoint < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKCREDITPOINT);
                return result;
            }
            var cMethod = QuestConditionInfo.sParam1[0];
            switch (cMethod)
        ...
        private bool ConditionOfCheckOfGuild(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (QuestConditionInfo.sParam1 == "")
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKOFGUILD);
                return result;
            }
            if (PlayObject.m_MyGuild != null)
            {
        ...
        private bool ConditionOfCheckOnlineLongMin(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nOnlineMin < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_ONLINELONGMIN);
                return result;
            }
        ...
        private bool ConditionOfCheckPasswordErrorCount(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nErrorCount < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_PASSWORDERRORCOUNT);
                return result;
            }
            var cMethod = QuestConditionInfo.sParam1[0];
            switch (cMethod)
        ...
        private bool ConditionOfCheckPayMent(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nPayMent < 1)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKPAYMENT);
                return result;
            }
        ...
        private bool ConditionOfCheckSlaveName(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (sSlaveName == "")
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKSLAVENAME);
                return result;
            }
            for (var i = 0; i < PlayObject.m_SlaveList.Count; i++)
            {
        ...
        private bool ConditionOfCheckNameDateList(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nDayCount < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKNAMEDATELIST);
                return result;
            }
        ...
        private bool ConditionOfCheckMapHumanCount(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            if (nCount < 0)
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKMAPHUMANCOUNT);
                return result;
            }
        ...
        private bool ConditionOfCheckMapMonCount(TPlayObject PlayObject, TQuestConditionInfo QuestConditionInfo)
        {
            ...
            {
                ScriptConditionError(PlayObject, QuestConditionInfo, ScriptCommandConst.sSC_CHECKMAPMONCOUNT);
                return result;
            }
