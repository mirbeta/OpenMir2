...
namespace GameSrv.GameCommand.Commands {
    ...
    public class AnnouncementCommand : GameCommand {
        ...
        public void Execute(string[] @params, PlayObject playObject) {
            ...
            //{
            //    PlayObject.SysMsg("查看行会争霸赛结果。", MsgColor.c_Red, MsgType.t_Hint);
            //    PlayObject.SysMsg(string.Format("命令格式: @{0} 行会名称", this.Attributes.Name), MsgColor.c_Red, MsgType.t_Hint);
            //    return;
            //}
            ...
            //        M2Share.WorldEngine.CryCry(Messages.RM_CRY, PlayObject.m_PEnvir, PlayObject.CurrX, PlayObject.CurrY, 1000,
