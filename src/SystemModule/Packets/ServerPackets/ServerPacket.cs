...
namespace SystemModule.Packets.ServerPackets
{
    public abstract class ServerPacket
    {
        ...
        public ServerPacket(byte[] segment)
        {
            if (segment == null)
            {
        ...
        public static T ToPacket<T>(Span<byte> rawBytes) where T : ServerPacket, new()
        {
            ServerPacket packet = Activator.CreateInstance<T>();
        ...
        public static T ToPacket<T>(byte[] rawBytes) where T : ServerPacket, new()
        {
            ServerPacket packet = Activator.CreateInstance<T>();
