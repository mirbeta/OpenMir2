...
namespace GameSvr.Npc
{
    public partial class NormNpc
    {
        ...
        private void ActionOfAddSkill(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_ADDSKILL);
            }
        }
        ...
        private void ActionOfAutoAddGameGold(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo, int nPoint, int nTime)
        {
            ...
            ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_AUTOADDGAMEGOLD);
        }
        ...
        private void ActionOfAutoGetExp(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_SETAUTOGETEXP);
                return;
            }
        ...
        private void ActionOfAutoSubGameGold(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo, int nPoint, int nTime)
        {
            ...
            ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_AUTOSUBGAMEGOLD);
        }
        ...
        private void ActionOfChangeCreditPoint(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nCreditPoint < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_CREDITPOINT);
                return;
            }
        ...
        private void ActionOfChangeExp(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nExp < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_CHANGEEXP);
                return;
            }
            var cMethod = QuestActionInfo.sParam1[0];
            switch (cMethod)
        ...
        private void ActionOfChangeHairStyle(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_HAIRSTYLE);
            }
        }
        ...
        private void ActionOfChangeLevel(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nLevel < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_CHANGELEVEL);
                return;
            }
            var cMethod = QuestActionInfo.sParam1[0];
            switch (cMethod)
        ...
        private void ActionOfChangePkPoint(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nPKPoint < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_CHANGEPKPOINT);
                return;
            }
            var cMethod = QuestActionInfo.sParam1[0];
            switch (cMethod)
        ...
        private void ActionOfDelSkill(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (Magic == null)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_DELSKILL);
                return;
            }
        ...
        private void ActionOfGameGold(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nGameGold < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_GAMEGOLD);
                return;
            }
            var cMethod = QuestActionInfo.sParam1[0];
            switch (cMethod)
        ...
        private void ActionOfGamePoint(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nGamePoint < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_GAMEPOINT);
                return;
            }
            var cMethod = QuestActionInfo.sParam1[0];
            switch (cMethod)
        ...
        private void ActionOfLineMsg(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            switch (QuestActionInfo.nParam1)
            {
                ...
                case 9:
                    ...
                    break;
                default:
                    ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSENDMSG);
                    break;
            }
        }
        ...
        private void ActionOfMission(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_MISSION);
            }
        }
        ...
        private void ActionOfMobFireBurn(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_MOBFIREBURN);
                return;
            }
        ...
        private void ActionOfMobPlace(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo, int nX, int nY, int nCount, int nRange)
        {
            ...
            for (var i = 0; i < nCount; i++)
            {
                ...
                {
                    ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_MOBPLACE);
                    break;
                }
            }
        }
        ...
        private void ActionOfSetRankLevelName(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (sRankLevelName == "")
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_SKILLLEVEL);
                return;
            }
        ...
        private void ActionOfSetScriptFlag(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            switch (nWhere)
            {
                ...
                case 1:
                    ...
                    break;
                default:
                    ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_SETSCRIPTFLAG);
                    break;
            }
        }
        ...
        private void ActionOfTakeCastleGold(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_TAKECASTLEGOLD);
                return;
            }
        ...
        private void ActionOfSaveVar(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_SAVEVAR);
                return;
            }
            boFoundVar = false;
            ...
            {
                Dispose(DynamicVar);
                ScriptActionError(PlayObject, format(sVarTypeError, sType), QuestActionInfo, ScriptCommandConst.sSC_VAR);
                return;
            }
            ...
            if (!boFoundVar)
            {
                ScriptActionError(PlayObject, format(sVarFound, sVarName, sType), QuestActionInfo, ScriptCommandConst.sSC_SAVEVAR);
            }
        }
        ...
        private void ActionOfCalcVar(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_CALCVAR);
                return;
            }
            ...
            if (sVarValue != "" && !HUtil32.IsStringNumber(sVarValue))
            {
                if (HUtil32.CompareLStr(sVarValue, "<$HUMAN(", 8))
                {
                    ...
                    if (!boFoundVar)
                    {
                        ScriptActionError(PlayObject, string.Format(sVarFound, sVarValue, sType), QuestActionInfo, ScriptCommandConst.sSC_CALCVAR);
                        return;
                    }
                }
                else
            ...
            {
                Dispose(DynamicVar);
                ScriptActionError(PlayObject, format(sVarTypeError, sType), QuestActionInfo, ScriptCommandConst.sSC_CALCVAR);
                return;
            }
            ...
            if (!boFoundVar)
            {
                ScriptActionError(PlayObject, format(sVarFound, sVarName, sType), QuestActionInfo, ScriptCommandConst.sSC_CALCVAR);
            }
        }
        ...
        private void ActionOfGroupMoveMap(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (!boFlag)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_GROUPMOVEMAP);
            }
        }
        ...
        private void ActionOfUpgradeItems(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_UPGRADEITEMS);
                return;
            }
        ...
        private void ActionOfUpgradeItemsEx(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_UPGRADEITEMSEX);
                return;
            }
            var UserItem = PlayObject.m_UseItems[nWhere];
            var StdItem = M2Share.UserEngine.GetStdItem(UserItem.wIndex);
        ...
        private void ActionOfVar(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_VAR);
                return;
            }
            if (string.Compare(QuestActionInfo.sParam1, "Integer", StringComparison.OrdinalIgnoreCase) == 0)
            {
            ...
            {
                ScriptActionError(PlayObject, format(sVarFound, sVarName, sType), QuestActionInfo, ScriptCommandConst.sSC_VAR);
            }
        }
        ...
        private void ActionOfLoadVar(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (sType == "" || sVarName == "" || !File.Exists(sFileName))
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_LOADVAR);
                return;
            }
            bool boFoundVar = false;
            DynamicVarList = GetDynamicVarList(PlayObject, sType, ref sName);
            ...
            if (!boFoundVar)
            {
                ScriptActionError(PlayObject, format(sVarFound, sVarName, sType), QuestActionInfo, ScriptCommandConst.sSC_LOADVAR);
            }
        }
        ...
        private void ActionOfClearNeedItems(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nNeed < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_CLEARNEEDITEMS);
                return;
            }
        ...
        private void ActionOfClearMakeItems(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_CLEARMAKEITEMS);
                return;
            }
            for (var i = PlayObject.m_ItemList.Count - 1; i >= 0; i--)
            {
        ...
        private void ActionOfSetMapMode(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_SETMAPMODE);
                return;
            }
        ...
        private void ActionOfSetMemberLevel(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nLevel < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_SETMEMBERLEVEL);
                return;
            }
        ...
        private void ActionOfSetMemberType(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nType < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_SETMEMBERTYPE);
                return;
            }
            char cMethod = QuestActionInfo.sParam1[0];
            switch (cMethod)
        ...
        private void ActionOfGiveItem(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_GIVE);
                return;
            }
        ...
        private void ActionOfGuildAuraePoint(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nAuraePoint < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_AURAEPOINT);
                return;
            }
            if (PlayObject.m_MyGuild == null)
            {
        ...
        private void ActionOfGuildBuildPoint(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nBuildPoint < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_BUILDPOINT);
                return;
            }
            if (PlayObject.m_MyGuild == null)
            {
        ...
        private void ActionOfGuildChiefItemCount(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nItemCount < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_GUILDCHIEFITEMCOUNT);
                return;
            }
            if (PlayObject.m_MyGuild == null)
            {
        ...
        private void ActionOfGuildFlourishPoint(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nFlourishPoint < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_FLOURISHPOINT);
                return;
            }
            if (PlayObject.m_MyGuild == null)
            {
        ...
        private void ActionOfGuildstabilityPoint(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_STABILITYPOINT);
                return;
            }
            if (PlayObject.m_MyGuild == null)
            {
        ...
        private void ActionOfHumanHP(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nHP < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_HUMANHP);
                return;
            }
            var cMethod = QuestActionInfo.sParam1[0];
            switch (cMethod)
        ...
        private void ActionOfHumanMP(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nMP < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_HUMANMP);
                return;
            }
            var cMethod = QuestActionInfo.sParam1[0];
            switch (cMethod)
        ...
        private void ActionOfKill(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_KILL);
            }
        }
        ...
        private void ActionOfBonusPoint(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_BONUSPOINT);
                return;
            }
            char cMethod = QuestActionInfo.sParam1[0];
            switch (cMethod)
        ...
        private void ActionOfChangeNameColor(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_CHANGENAMECOLOR);
                return;
            }
        ...
        private void ActionOfReNewLevel(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_RENEWLEVEL);
                return;
            }
        ...
        private void ActionOfChangeGender(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nGender > 1)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_CHANGEGENDER);
                return;
            }
        ...
        private void ActionOfKillMonExpRate(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nRate < 0 || nTime < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_KILLMONEXPRATE);
                return;
            }
        ...
        private void ActionOfMonGenEx(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_MONGENEX);
                return;
            }
            for (var i = 0; i < nCount; i++)
            {
        ...
        private void ActionOfOpenMagicBox(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (sMonName == "")
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_OPENMAGICBOX);
                return;
            }
        ...
        private void ActionOfPkZone(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_PKZONE);
                return;
            }
        ...
        private void ActionOfPowerRate(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            if (nRate < 0 || nTime < 0)
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_POWERRATE);
                return;
            }
        ...
        private void ActionOfChangeMode(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_CHANGEMODE);
            }
        }
        ...
        private void ActionOfChangePerMission(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            {
                ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sSC_CHANGEPERMISSION);
                return;
            }
            if (M2Share.g_Config.boShowScriptActionMsg)
            {
        ...
        private void ActionOfTHROWITEM(TPlayObject PlayObject, TQuestActionInfo QuestActionInfo)
        {
            ...
            try
            {
                ...
                {
                    ScriptActionError(PlayObject, "", QuestActionInfo, ScriptCommandConst.sTHROWITEM);
                    return;
                }
