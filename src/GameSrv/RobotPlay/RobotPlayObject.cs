...
namespace GameSrv.RobotPlay {
    ...
    public partial class RobotPlayObject : PlayObject {
        ...
        /// 查询魔法
        /// </summary>
        public short MNSelectMagic;
        /// <summary>
        /// 是否可以使用的魔法(True才可能躲避)
        /// </summary>
        public bool MBoIsUseMagic;
        /// <summary>
        /// 是否可以使用的攻击魔法
        /// </summary>
        ...
        /// 自动躲避间隔
        /// </summary>
        public long MDwAutoAvoidTick;
        public bool MBoIsNeedAvoid;
        /// <summary>
        /// 假人掉装备机率
        /// </summary>
        ...
        public RobotPlayObject() : base() {
            ...
            MDwAutoAvoidTick = HUtil32.GetTickCount();// 自动躲避间隔
            MBoIsNeedAvoid = false;// 是否需要躲避
        ...
        private bool IsNeedGotoXy() {
            bool result = false;
            long dwAttackTime;
            if (TargetCret != null && HUtil32.GetTickCount() - MDwAutoAvoidTick > 1100 && (!MBoIsUseAttackMagic || Job == 0)) {
                if (Job > 0) {
                    if (!MBoIsUseMagic && (Math.Abs(TargetCret.CurrX - CurrX) > 3 || Math.Abs(TargetCret.CurrY - CurrY) > 3)) {
                        return true;
                    }
