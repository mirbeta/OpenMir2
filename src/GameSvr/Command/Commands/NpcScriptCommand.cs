    ...
    public class NpcScriptCommand : BaseCommond
    {
        ...
        public void NpcScript(PlayObject PlayObject)
        {
            ...
            if (nNPCType == 0)
            {
                ...
                sScriptFileName = M2Share.sConfigPath + M2Share.Config.sEnvirDir + ScriptConst.sMarket_Def + Merchant.m_sScript + "-" + Merchant.MapName + ".txt";
            }
            if (nNPCType == 1)
            {
                var NormNpc = (NormNpc)BaseObject;
                sScriptFileName = M2Share.sConfigPath + M2Share.Config.sEnvirDir + ScriptConst.sNpc_def + NormNpc.CharName + "-" + NormNpc.MapName + ".txt";
            }
