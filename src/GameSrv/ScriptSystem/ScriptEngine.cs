    ...
    public partial class ScriptEngine {
        ...
        public ScriptEngine()
        {
            ...
            if (conditionFields.Length > 0)
            {
                ...
                {
                    var codeField = conditionFields[i].GetCustomAttribute<ScriptCode>();
                    if (codeField != null)
                    {
            ...
            if (executionFields.Length > 0)
            {
                ...
                {
                    var codeField = executionFields[i].GetCustomAttribute<ScriptCode>();
                    if (codeField != null)
                    {
        ...
        private static void InitializeVariable(string sLabel, ref string sMsg) {
            ...
            else if (sLabel2 == GrobalVarCode.sVAR_FBMAPNAME) { //副本
