...
namespace CommandModule.Commands
{
    ...
    public class GuildRecallCommand : GameCommand
    {
        ...
        {
            if (!PlayerActor.GuildMove && PlayerActor.Permission < 6)
            {
            ...
            var mCastle = ModuleShare.CastleMgr.InCastleWarArea(PlayerActor);
            ...
            //    {
            //        var memberObject = ModuleShare.WorldEngine.GetPlayObject(guildRank.MemberList[j].MemberName);
            //        if (memberObject != null)
            //        {
            //            if (memberObject == PlayerActor)
            //            {
            //                // Inc(nNoRecallCount);
            //                continue;
            //            }
            ...
            PlayerActor.GroupRcallTime = (short)ModuleShare.Config.GuildRecallTime;
        }
    }
}