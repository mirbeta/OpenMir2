...
namespace M2Server
{
    ...
    public class ShowMapInfoCommand : BaseCommond
    {
        ...
        public void ShowMapInfo(string[] @Params, TPlayObject PlayObject)
        {
            ...
            PlayObject.SysMsg(string.Format(M2Share.g_sGameCommandMapInfoMsg, PlayObject.m_PEnvir.sMapName,
                PlayObject.m_PEnvir.sMapDesc), TMsgColor.c_Green, TMsgType.t_Hint);
            PlayObject.SysMsg(string.Format(M2Share.g_sGameCommandMapInfoSizeMsg, PlayObject.m_PEnvir.wWidth,
                PlayObject.m_PEnvir.wHeight), TMsgColor.c_Green, TMsgType.t_Hint);
        }
    }
}