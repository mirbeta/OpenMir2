...
namespace M2Server
{
    public class TUserCastle
    {
        ...
        private void LoadConfig()
        {
            ...
            m_MainDoor.nX = CastleConf.ReadInteger("Defense", "MainDoorX", (short) 672);
            m_MainDoor.nY = CastleConf.ReadInteger("Defense", "MainDoorY", (short) 330);
            ...
            m_MainDoor.nHP = CastleConf.ReadInteger("Defense", "MainDoorHP", (short) 2000);
            m_MainDoor.BaseObject = null;
            m_LeftWall = new TObjUnit();
            m_LeftWall.nX = CastleConf.ReadInteger("Defense", "LeftWallX", (short) 624);
            m_LeftWall.nY = CastleConf.ReadInteger("Defense", "LeftWallY", (short) 278);
            m_LeftWall.sName = CastleConf.ReadString("Defense", "LeftWallName", "LeftWall");
            m_LeftWall.nHP = CastleConf.ReadInteger("Defense", "LeftWallHP", (short) 2000);
            m_LeftWall.BaseObject = null;
            m_CenterWall = new TObjUnit();
            m_CenterWall.nX = CastleConf.ReadInteger("Defense", "CenterWallX", (short) 627);
            m_CenterWall.nY = CastleConf.ReadInteger("Defense", "CenterWallY", (short) 278);
            m_CenterWall.sName = CastleConf.ReadString("Defense", "CenterWallName", "CenterWall");
            m_CenterWall.nHP = CastleConf.ReadInteger("Defense", "CenterWallHP", (short) 2000);
            m_CenterWall.BaseObject = null;
            m_RightWall = new TObjUnit();
            m_RightWall.nX = CastleConf.ReadInteger("Defense", "RightWallX", (short) 634);
            m_RightWall.nY = CastleConf.ReadInteger("Defense", "RightWallY", (short) 271);
            m_RightWall.sName = CastleConf.ReadString("Defense", "RightWallName", "RightWall");
            m_RightWall.nHP = CastleConf.ReadInteger("Defense", "RightWallHP", (short) 2000);
            m_RightWall.BaseObject = null;
            for (var i = m_Archer.GetLowerBound(0); i <= m_Archer.GetUpperBound(0); i++)
            {
                objUnit = new TObjUnit();
                objUnit.nX = CastleConf.ReadInteger("Defense", "Archer_" + i + 1 + "_X", (short) 0);
                objUnit.nY = CastleConf.ReadInteger("Defense", "Archer_" + i + 1 + "_Y", (short) 0);
                objUnit.sName = CastleConf.ReadString("Defense", "Archer_" + i + 1 + "_Name", "弓箭手");
                objUnit.nHP = CastleConf.ReadInteger("Defense", "Archer_" + i + 1 + "_HP", (short) 2000);
            ...
            {
                objUnit = new TObjUnit();
                objUnit.nX = CastleConf.ReadInteger("Defense", "Guard_" + i + 1 + "_X", (short) 0);
                objUnit.nY = CastleConf.ReadInteger("Defense", "Guard_" + i + 1 + "_Y", (short) 0);
                objUnit.sName = CastleConf.ReadString("Defense", "Guard_" + i + 1 + "_Name", "守卫");
                objUnit.nHP = CastleConf.ReadInteger("Defense", "Guard_" + i + 1 + "_HP", (short) 2000);
                objUnit.BaseObject = null;
                m_Guard[i] = objUnit;
            }
