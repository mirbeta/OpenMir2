...
namespace SystemModule.CoreSocket
{
    ...
    public class UdpSessionBase : BaseSocket, IUdpSession, IPluginObject
    {
        ...
        private SystemModule.CoreSocket.Common.NetworkMonitor m_monitor;
        ...
        public UdpSessionBase()
        {
            ...
            m_monitor = new SystemModule.CoreSocket.Common.NetworkMonitor(null, socket);
        }
        ...
        /// 监听器
        /// </summary>
        public SystemModule.CoreSocket.Common.NetworkMonitor Monitor => m_monitor;
        ...
        public IService Stop()
        {
            ...
            foreach (SocketAsyncEventArgs item in m_socketAsyncs)
            {
                item.SafeDispose();
            }
        ...
        private void BeginReceive(IPHost iPHost)
        {
            ...
            m_monitor = new SystemModule.CoreSocket.Common.NetworkMonitor(iPHost, socket);
