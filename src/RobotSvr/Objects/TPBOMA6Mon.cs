        ...
        public override void Run()
        {
            ...
            if (this.m_nCurrentAction != 0)
            {
                ...
                if (MShare.GetTickCount() - this.m_dwStartTime > m_dwFrameTimetime)
                {
                    ...
                    {
                        meff = ((TFlyingAxe)(ClMain.g_PlayScene.NewFlyObject(this, this.m_nCurrX, this.m_nCurrY, MShare.g_nTargetX, MShare.g_nTargetY, this.m_nTargetRecog, magiceff.TMagicType.mtFlyBolt)));
                        if (meff != null)
                        {
                            meff.ImgLib = WMFile.Units.WMFile.g_WMons[22];
