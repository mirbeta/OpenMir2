...
namespace GameSvr.Configs
{
    ...
    {
        public readonly IniFile _config;
        ...
        public void LoadConfig()
        {
            ...
            M2Share.g_Config.boVentureServer = _config.ReadString("Server", "VentureServer", "FALSE").ToLower()
            ...
            M2Share.g_Config.boTestServer =
                _config.ReadString("Server", "TestServer", "FALSE").ToLower().CompareTo("TRUE".ToLower()) == 0;
            ...
            M2Share.g_Config.nTestUserLimit =
                _config.ReadInteger("Server", "TestServerUserLimit", M2Share.g_Config.nTestUserLimit);
            ...
            M2Share.g_Config.boServiceMode =
                _config.ReadString("Server", "ServiceMode", "FALSE").ToLower().CompareTo("TRUE".ToLower()) == 0;
            ...
            M2Share.g_Config.boNonPKServer =
                _config.ReadString("Server", "NonPKServer", "FALSE").ToLower().CompareTo("TRUE".ToLower()) == 0;
            ...
            M2Share.g_Config.boViewHackMessage = _config.ReadString("Server", "ViewHackMessage", "FALSE").ToLower()
                                                     .CompareTo("TRUE".ToLower()) == 0;
            if (_config.ReadString("Server", "ViewAdmissionFailure", "") == "")
                _config.WriteString("Server", "ViewAdmissionFailure",
                    HUtil32.BoolToStr(M2Share.g_Config.boViewAdmissionFailure));
            M2Share.g_Config.boViewAdmissionFailure = _config.ReadString("Server", "ViewAdmissionFailure", "FALSE")
            ...
            M2Share.g_Config.sLogServerAddr =
                _config.ReadString("Server", "LogServerAddr", M2Share.g_Config.sLogServerAddr);
            ...
            M2Share.g_Config.nLogServerPort =
                _config.ReadInteger("Server", "LogServerPort", M2Share.g_Config.nLogServerPort);
            if (_config.ReadString("Server", "DiscountForNightTime", "") == "")
                _config.WriteString("Server", "DiscountForNightTime",
                    HUtil32.BoolToStr(M2Share.g_Config.boDiscountForNightTime));
            M2Share.g_Config.boDiscountForNightTime = _config.ReadString("Server", "DiscountForNightTime", "FALSE")
                                                          .ToLower().CompareTo("TRUE".ToLower()) == 0;
            ...
            M2Share.g_Config.nHalfFeeStart =
                _config.ReadInteger("Server", "HalfFeeStart", M2Share.g_Config.nHalfFeeStart);
            ...
            M2Share.g_Config.nAvailableBlock =
                _config.ReadInteger("Server", "AvailableBlock", M2Share.g_Config.nAvailableBlock);
            ...
            M2Share.g_Config.dwProcessMonstersTime = _config.ReadInteger("Server", "ProcessMonstersTime",
            ...
            M2Share.g_Config.dwRegenMonstersTime =
                _config.ReadInteger("Server", "RegenMonstersTime", M2Share.g_Config.dwRegenMonstersTime);
            ...
            M2Share.g_Config.dwHumanGetMsgTime =
                _config.ReadInteger("Server", "HumanGetMsgTimeLimit", M2Share.g_Config.dwHumanGetMsgTime);
            ...
            if (_config.ReadString("Share", "PlugDir", "") == "")
                _config.WriteString("Share", "PlugDir", M2Share.g_Config.sPlugDir);
            M2Share.g_Config.sPlugDir = _config.ReadString("Share", "PlugDir", M2Share.g_Config.sPlugDir);
            // ============================================================================
            // 名称设置
            ...
            M2Share.g_Config.sFireBallSkill =
                _config.ReadString("Names", "FireBallSkill", M2Share.g_Config.sFireBallSkill);
            ...
            if (_config.ReadString("Names", "Bee", "") == "") _config.WriteString("Names", "Bee", M2Share.g_Config.sBee);
            ...
            M2Share.g_Config.nItemNumberEx =
                _config.ReadInteger("Setup", "ItemNumberEx", M2Share.g_Config.nItemNumberEx);
            ...
            M2Share.g_Config.nMonUpLvNeedKillBase =
                _config.ReadInteger("Setup", "MonUpLvNeedKillBase", M2Share.g_Config.nMonUpLvNeedKillBase);
                ...
                I++)
            {
                ...
                M2Share.g_Config.MonUpLvNeedKillCount[I] = _config.ReadInteger("Setup", "MonUpLvNeedKillCount" + I,
                ...
                I++)
            {
                ...
                M2Share.g_Config.SlaveColor[I] =
                    _config.ReadInteger<byte>("Setup", "SlaveColor" + I, M2Share.g_Config.SlaveColor[I]);
            }
            ...
            M2Share.g_Config.sRedDieHomeMap =
                _config.ReadString("Setup", "RedDieHomeMap", M2Share.g_Config.sRedDieHomeMap);
            ...
            M2Share.g_Config.boJobHomePoint =
                _config.ReadBool("Setup", "JobHomePointSystem", M2Share.g_Config.boJobHomePoint);
            ...
            M2Share.g_Config.sWarriorHomeMap =
                _config.ReadString("Setup", "WarriorHomeMap", M2Share.g_Config.sWarriorHomeMap);
            ...
            M2Share.g_Config.nWarriorHomeX =
                _config.ReadInteger<short>("Setup", "WarriorHomeX", M2Share.g_Config.nWarriorHomeX);
            ...
            M2Share.g_Config.nWarriorHomeY =
                _config.ReadInteger<short>("Setup", "WarriorHomeY", M2Share.g_Config.nWarriorHomeY);
            ...
            M2Share.g_Config.sWizardHomeMap =
                _config.ReadString("Setup", "WizardHomeMap", M2Share.g_Config.sWizardHomeMap);
            ...
            M2Share.g_Config.sTaoistHomeMap =
                _config.ReadString("Setup", "TaoistHomeMap", M2Share.g_Config.sTaoistHomeMap);
            ...
            M2Share.g_Config.dwDecPkPointTime =
                _config.ReadInteger("Setup", "DecPkPointTime", M2Share.g_Config.dwDecPkPointTime);
            ...
            M2Share.g_Config.nDecPkPointCount =
                _config.ReadInteger("Setup", "DecPkPointCount", M2Share.g_Config.nDecPkPointCount);
            ...
            M2Share.g_Config.nKillHumanAddPKPoint =
                _config.ReadInteger("Setup", "KillHumanAddPKPoint", M2Share.g_Config.nKillHumanAddPKPoint);
            ...
            M2Share.g_Config.nKillHumanDecLuckPoint = _config.ReadInteger("Setup", "KillHumanDecLuckPoint",
            ...
            M2Share.g_Config.dwDecLightItemDrugTime = _config.ReadInteger("Setup", "DecLightItemDrugTime",
                ...
                I++)
            {
                ...
                M2Share.g_Config.ReNewNameColor[I] =
                    _config.ReadInteger<byte>("Setup", "ReNewNameColor" + I, M2Share.g_Config.ReNewNameColor[I]);
            }
            ...
            M2Share.g_Config.dwReNewNameColorTime =
                _config.ReadInteger("Setup", "ReNewNameColorTime", M2Share.g_Config.dwReNewNameColorTime);
            ...
            M2Share.g_Config.boReNewChangeColor =
                _config.ReadBool("Setup", "ReNewChangeColor", M2Share.g_Config.boReNewChangeColor);
            ...
            M2Share.g_Config.boReNewLevelClearExp =
                _config.ReadBool("Setup", "ReNewLevelClearExp", M2Share.g_Config.boReNewLevelClearExp);
            ...
            M2Share.g_Config.BonusAbilofWarr.DC =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofWarrDC", M2Share.g_Config.BonusAbilofWarr.DC);
            ...
            M2Share.g_Config.BonusAbilofWarr.MC =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofWarrMC", M2Share.g_Config.BonusAbilofWarr.MC);
            ...
            M2Share.g_Config.BonusAbilofWarr.SC =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofWarrSC", M2Share.g_Config.BonusAbilofWarr.SC);
            ...
            M2Share.g_Config.BonusAbilofWarr.AC =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofWarrAC", M2Share.g_Config.BonusAbilofWarr.AC);
            ...
            M2Share.g_Config.BonusAbilofWarr.MAC =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofWarrMAC", M2Share.g_Config.BonusAbilofWarr.MAC);
            ...
            M2Share.g_Config.BonusAbilofWarr.HP =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofWarrHP", M2Share.g_Config.BonusAbilofWarr.HP);
            ...
            M2Share.g_Config.BonusAbilofWarr.MP =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofWarrMP", M2Share.g_Config.BonusAbilofWarr.MP);
            ...
            M2Share.g_Config.BonusAbilofWarr.Hit =
                _config.ReadInteger<byte>("Setup", "BonusAbilofWarrHit", M2Share.g_Config.BonusAbilofWarr.Hit);
            ...
            M2Share.g_Config.BonusAbilofWarr.Speed = _config.ReadInteger("Setup", "BonusAbilofWarrSpeed",
            ...
            M2Share.g_Config.BonusAbilofWarr.X2 =
                _config.ReadInteger<byte>("Setup", "BonusAbilofWarrX2", M2Share.g_Config.BonusAbilofWarr.X2);
            ...
            M2Share.g_Config.BonusAbilofWizard.DC =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofWizardDC", M2Share.g_Config.BonusAbilofWizard.DC);
            ...
            M2Share.g_Config.BonusAbilofWizard.MC =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofWizardMC", M2Share.g_Config.BonusAbilofWizard.MC);
            ...
            M2Share.g_Config.BonusAbilofWizard.SC =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofWizardSC", M2Share.g_Config.BonusAbilofWizard.SC);
            ...
            M2Share.g_Config.BonusAbilofWizard.AC =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofWizardAC", M2Share.g_Config.BonusAbilofWizard.AC);
            ...
            M2Share.g_Config.BonusAbilofWizard.MAC = _config.ReadInteger<ushort>("Setup", "BonusAbilofWizardMAC",
            ...
            M2Share.g_Config.BonusAbilofWizard.HP =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofWizardHP", M2Share.g_Config.BonusAbilofWizard.HP);
            ...
            M2Share.g_Config.BonusAbilofWizard.MP =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofWizardMP", M2Share.g_Config.BonusAbilofWizard.MP);
            ...
            M2Share.g_Config.BonusAbilofWizard.Hit = _config.ReadInteger<byte>("Setup", "BonusAbilofWizardHit",
            ...
            M2Share.g_Config.BonusAbilofWizard.Speed = _config.ReadInteger("Setup", "BonusAbilofWizardSpeed",
            ...
            M2Share.g_Config.BonusAbilofWizard.X2 =
                _config.ReadInteger<byte>("Setup", "BonusAbilofWizardX2", M2Share.g_Config.BonusAbilofWizard.X2);
            ...
            M2Share.g_Config.BonusAbilofTaos.DC =
                _config.ReadInteger<byte>("Setup", "BonusAbilofTaosDC", M2Share.g_Config.BonusAbilofTaos.DC);
            ...
            M2Share.g_Config.BonusAbilofTaos.MC =
                _config.ReadInteger<byte>("Setup", "BonusAbilofTaosMC", M2Share.g_Config.BonusAbilofTaos.MC);
            ...
            M2Share.g_Config.BonusAbilofTaos.SC =
                _config.ReadInteger<byte>("Setup", "BonusAbilofTaosSC", M2Share.g_Config.BonusAbilofTaos.SC);
            ...
            M2Share.g_Config.BonusAbilofTaos.AC =
                _config.ReadInteger<byte>("Setup", "BonusAbilofTaosAC", M2Share.g_Config.BonusAbilofTaos.AC);
            ...
            M2Share.g_Config.BonusAbilofTaos.MAC =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofTaosMAC", M2Share.g_Config.BonusAbilofTaos.MAC);
            ...
            M2Share.g_Config.BonusAbilofTaos.HP =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofTaosHP", M2Share.g_Config.BonusAbilofTaos.HP);
            ...
            M2Share.g_Config.BonusAbilofTaos.MP =
                _config.ReadInteger<ushort>("Setup", "BonusAbilofTaosMP", M2Share.g_Config.BonusAbilofTaos.MP);
            ...
            M2Share.g_Config.BonusAbilofTaos.Hit =
                _config.ReadInteger<byte>("Setup", "BonusAbilofTaosHit", M2Share.g_Config.BonusAbilofTaos.Hit);
            ...
            M2Share.g_Config.BonusAbilofTaos.Speed = _config.ReadInteger("Setup", "BonusAbilofTaosSpeed",
            ...
            M2Share.g_Config.NakedAbilofWarr.DC =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofWarrDC", M2Share.g_Config.NakedAbilofWarr.DC);
            ...
            M2Share.g_Config.NakedAbilofWarr.MC =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofWarrMC", M2Share.g_Config.NakedAbilofWarr.MC);
            ...
            M2Share.g_Config.NakedAbilofWarr.SC =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofWarrSC", M2Share.g_Config.NakedAbilofWarr.SC);
            ...
            M2Share.g_Config.NakedAbilofWarr.AC =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofWarrAC", M2Share.g_Config.NakedAbilofWarr.AC);
            ...
            M2Share.g_Config.NakedAbilofWarr.MAC =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofWarrMAC", M2Share.g_Config.NakedAbilofWarr.MAC);
            ...
            M2Share.g_Config.NakedAbilofWarr.HP =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofWarrHP", M2Share.g_Config.NakedAbilofWarr.HP);
            ...
            M2Share.g_Config.NakedAbilofWarr.MP =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofWarrMP", M2Share.g_Config.NakedAbilofWarr.MP);
            ...
            M2Share.g_Config.NakedAbilofWarr.Hit =
                _config.ReadInteger<byte>("Setup", "NakedAbilofWarrHit", M2Share.g_Config.NakedAbilofWarr.Hit);
            ...
            M2Share.g_Config.NakedAbilofWarr.Speed = _config.ReadInteger("Setup", "NakedAbilofWarrSpeed",
            ...
            M2Share.g_Config.NakedAbilofWarr.X2 =
                _config.ReadInteger<byte>("Setup", "NakedAbilofWarrX2", M2Share.g_Config.NakedAbilofWarr.X2);
            ...
            M2Share.g_Config.NakedAbilofWizard.DC =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofWizardDC", M2Share.g_Config.NakedAbilofWizard.DC);
            ...
            M2Share.g_Config.NakedAbilofWizard.MC =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofWizardMC", M2Share.g_Config.NakedAbilofWizard.MC);
            ...
            M2Share.g_Config.NakedAbilofWizard.SC =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofWizardSC", M2Share.g_Config.NakedAbilofWizard.SC);
            ...
            M2Share.g_Config.NakedAbilofWizard.AC =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofWizardAC", M2Share.g_Config.NakedAbilofWizard.AC);
            ...
            M2Share.g_Config.NakedAbilofWizard.HP =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofWizardHP", M2Share.g_Config.NakedAbilofWizard.HP);
            ...
            M2Share.g_Config.NakedAbilofWizard.MP =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofWizardMP", M2Share.g_Config.NakedAbilofWizard.MP);
            ...
            M2Share.g_Config.NakedAbilofWizard.Hit = _config.ReadInteger<byte>("Setup", "NakedAbilofWizardHit",
            ...
            M2Share.g_Config.NakedAbilofWizard.Speed = _config.ReadInteger("Setup", "NakedAbilofWizardSpeed",
            ...
            M2Share.g_Config.NakedAbilofWizard.X2 =
                _config.ReadInteger<byte>("Setup", "NakedAbilofWizardX2", M2Share.g_Config.NakedAbilofWizard.X2);
            ...
            M2Share.g_Config.NakedAbilofTaos.DC =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofTaosDC", M2Share.g_Config.NakedAbilofTaos.DC);
            ...
            M2Share.g_Config.NakedAbilofTaos.MC =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofTaosMC", M2Share.g_Config.NakedAbilofTaos.MC);
            ...
            M2Share.g_Config.NakedAbilofTaos.AC =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofTaosAC", M2Share.g_Config.NakedAbilofTaos.AC);
            ...
            M2Share.g_Config.NakedAbilofTaos.MAC =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofTaosMAC", M2Share.g_Config.NakedAbilofTaos.MAC);
            ...
            M2Share.g_Config.NakedAbilofTaos.HP =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofTaosHP", M2Share.g_Config.NakedAbilofTaos.HP);
            ...
            M2Share.g_Config.NakedAbilofTaos.MP =
                _config.ReadInteger<ushort>("Setup", "NakedAbilofTaosMP", M2Share.g_Config.NakedAbilofTaos.MP);
            ...
            M2Share.g_Config.NakedAbilofTaos.Hit =
                _config.ReadInteger<byte>("Setup", "NakedAbilofTaosHit", M2Share.g_Config.NakedAbilofTaos.Hit);
            ...
            M2Share.g_Config.NakedAbilofTaos.Speed = _config.ReadInteger("Setup", "NakedAbilofTaosSpeed",
            ...
            M2Share.g_Config.NakedAbilofTaos.X2 =
                _config.ReadInteger<byte>("Setup", "NakedAbilofTaosX2", M2Share.g_Config.NakedAbilofTaos.X2);
            ...
            M2Share.g_Config.nGroupMembersMax =
                _config.ReadInteger("Setup", "GroupMembersMax", M2Share.g_Config.nGroupMembersMax);
            ...
            M2Share.g_Config.dwUPgradeWeaponGetBackTime = _config.ReadInteger("Setup", "UPgradeWeaponGetBackTime",
                M2Share.g_Config.dwUPgradeWeaponGetBackTime);
            if (_config.ReadInteger("Setup", "ClearExpireUpgradeWeaponDays", -1) < 0)
                _config.WriteInteger("Setup", "ClearExpireUpgradeWeaponDays",
                    M2Share.g_Config.nClearExpireUpgradeWeaponDays);
            M2Share.g_Config.nClearExpireUpgradeWeaponDays = _config.ReadInteger("Setup", "ClearExpireUpgradeWeaponDays",
                M2Share.g_Config.nClearExpireUpgradeWeaponDays);
            ...
            M2Share.g_Config.nUpgradeWeaponPrice =
                _config.ReadInteger("Setup", "UpgradeWeaponPrice", M2Share.g_Config.nUpgradeWeaponPrice);
            ...
            M2Share.g_Config.nUpgradeWeaponMaxPoint = _config.ReadInteger("Setup", "UpgradeWeaponMaxPoint",
            ...
            M2Share.g_Config.nUpgradeWeaponDCRate =
                _config.ReadInteger("Setup", "UpgradeWeaponDCRate", M2Share.g_Config.nUpgradeWeaponDCRate);
            if (_config.ReadInteger("Setup", "UpgradeWeaponDCTwoPointRate", -1) < 0)
                _config.WriteInteger("Setup", "UpgradeWeaponDCTwoPointRate",
                    M2Share.g_Config.nUpgradeWeaponDCTwoPointRate);
            M2Share.g_Config.nUpgradeWeaponDCTwoPointRate = _config.ReadInteger("Setup", "UpgradeWeaponDCTwoPointRate",
                M2Share.g_Config.nUpgradeWeaponDCTwoPointRate);
            if (_config.ReadInteger("Setup", "UpgradeWeaponDCThreePointRate", -1) < 0)
                _config.WriteInteger("Setup", "UpgradeWeaponDCThreePointRate",
                    M2Share.g_Config.nUpgradeWeaponDCThreePointRate);
            M2Share.g_Config.nUpgradeWeaponDCThreePointRate = _config.ReadInteger("Setup",
            ...
            M2Share.g_Config.nUpgradeWeaponMCRate =
                _config.ReadInteger("Setup", "UpgradeWeaponMCRate", M2Share.g_Config.nUpgradeWeaponMCRate);
            if (_config.ReadInteger("Setup", "UpgradeWeaponMCTwoPointRate", -1) < 0)
                _config.WriteInteger("Setup", "UpgradeWeaponMCTwoPointRate",
                    M2Share.g_Config.nUpgradeWeaponMCTwoPointRate);
            M2Share.g_Config.nUpgradeWeaponMCTwoPointRate = _config.ReadInteger("Setup", "UpgradeWeaponMCTwoPointRate",
                M2Share.g_Config.nUpgradeWeaponMCTwoPointRate);
            if (_config.ReadInteger("Setup", "UpgradeWeaponMCThreePointRate", -1) < 0)
                _config.WriteInteger("Setup", "UpgradeWeaponMCThreePointRate",
                    M2Share.g_Config.nUpgradeWeaponMCThreePointRate);
            M2Share.g_Config.nUpgradeWeaponMCThreePointRate = _config.ReadInteger("Setup",
            ...
            if (_config.ReadInteger("Setup", "UpgradeWeaponSCTwoPointRate", -1) < 0)
                _config.WriteInteger("Setup", "UpgradeWeaponSCTwoPointRate",
                    M2Share.g_Config.nUpgradeWeaponSCTwoPointRate);
            M2Share.g_Config.nUpgradeWeaponSCTwoPointRate = _config.ReadInteger("Setup", "UpgradeWeaponSCTwoPointRate",
                M2Share.g_Config.nUpgradeWeaponSCTwoPointRate);
            if (_config.ReadInteger("Setup", "UpgradeWeaponSCThreePointRate", -1) < 0)
                _config.WriteInteger("Setup", "UpgradeWeaponSCThreePointRate",
                    M2Share.g_Config.nUpgradeWeaponSCThreePointRate);
            M2Share.g_Config.nUpgradeWeaponSCThreePointRate = _config.ReadInteger("Setup",
            ...
            M2Share.g_Config.nBuildGuildPrice =
                _config.ReadInteger("Setup", "BuildGuild", M2Share.g_Config.nBuildGuildPrice);
            ...
            M2Share.g_Config.nGuildWarPrice =
                _config.ReadInteger("Setup", "GuildWarFee", M2Share.g_Config.nGuildWarPrice);
            ...
            M2Share.g_Config.nHireGuardPrice =
                _config.ReadInteger("Setup", "HireGuard", M2Share.g_Config.nHireGuardPrice);
            ...
            M2Share.g_Config.nHireArcherPrice =
                _config.ReadInteger("Setup", "HireArcher", M2Share.g_Config.nHireArcherPrice);
            ...
            M2Share.g_Config.nRepairDoorPrice =
                _config.ReadInteger("Setup", "RepairDoor", M2Share.g_Config.nRepairDoorPrice);
            ...
            M2Share.g_Config.nRepairWallPrice =
                _config.ReadInteger("Setup", "RepairWall", M2Share.g_Config.nRepairWallPrice);
            ...
            M2Share.g_Config.nCastleMemberPriceRate = _config.ReadInteger("Setup", "CastleMemberPriceRate",
            ...
            M2Share.g_Config.nCastleGoldMax =
                _config.ReadInteger("Setup", "CastleGoldMax", M2Share.g_Config.nCastleGoldMax);
            ...
            M2Share.g_Config.nCastleOneDayGold =
                _config.ReadInteger("Setup", "CastleOneDayGold", M2Share.g_Config.nCastleOneDayGold);
            ...
            M2Share.g_Config.sCastleHomeMap =
                _config.ReadString("Setup", "CastleHomeMap", M2Share.g_Config.sCastleHomeMap);
            ...
            M2Share.g_Config.nCastleWarRangeX =
                _config.ReadInteger("Setup", "CastleWarRangeX", M2Share.g_Config.nCastleWarRangeX);
            ...
            M2Share.g_Config.nCastleWarRangeY =
                _config.ReadInteger("Setup", "CastleWarRangeY", M2Share.g_Config.nCastleWarRangeY);
            ...
            M2Share.g_Config.nCastleTaxRate =
                _config.ReadInteger("Setup", "CastleTaxRate", M2Share.g_Config.nCastleTaxRate);
            ...
            M2Share.g_Config.boGetAllNpcTax =
                _config.ReadBool("Setup", "CastleGetAllNpcTax", M2Share.g_Config.boGetAllNpcTax);
            ...
            M2Share.g_Config.nHumanMaxGold =
                _config.ReadInteger("Setup", "HumanMaxGold", M2Share.g_Config.nHumanMaxGold);
            ...
            M2Share.g_Config.nHumanTryModeMaxGold =
                _config.ReadInteger("Setup", "HumanTryModeMaxGold", M2Share.g_Config.nHumanTryModeMaxGold);
            ...
            M2Share.g_Config.nTryModeLevel =
                _config.ReadInteger("Setup", "TryModeLevel", M2Share.g_Config.nTryModeLevel);
            ...
            M2Share.g_Config.boTryModeUseStorage =
                _config.ReadBool("Setup", "TryModeUseStorage", M2Share.g_Config.boTryModeUseStorage);
            ...
            M2Share.g_Config.boShutRedMsgShowGMName = _config.ReadBool("Setup", "ShutRedMsgShowGMName",
            ...
            M2Share.g_Config.boShowMakeItemMsg =
                _config.ReadBool("Setup", "ShowMakeItemMsg", M2Share.g_Config.boShowMakeItemMsg);
            ...
            M2Share.g_Config.boShowGuildName =
                _config.ReadBool("Setup", "ShowGuildName", M2Share.g_Config.boShowGuildName);
            ...
            M2Share.g_Config.boShowRankLevelName =
                _config.ReadBool("Setup", "ShowRankLevelName", M2Share.g_Config.boShowRankLevelName);
            ...
            M2Share.g_Config.nSayMsgMaxLen =
                _config.ReadInteger("Setup", "SayMsgMaxLen", M2Share.g_Config.nSayMsgMaxLen);
            ...
            M2Share.g_Config.dwDisableSayMsgTime =
                _config.ReadInteger("Setup", "DisableSayMsgTime", M2Share.g_Config.dwDisableSayMsgTime);
            ...
            M2Share.g_Config.nSayRedMsgMaxLen =
                _config.ReadInteger("Setup", "SayRedMsgMaxLen", M2Share.g_Config.nSayRedMsgMaxLen);
            ...
            M2Share.g_Config.nCanShoutMsgLevel =
                _config.ReadInteger("Setup", "CanShoutMsgLevel", M2Share.g_Config.nCanShoutMsgLevel);
            ...
            M2Share.g_Config.nStartPermission =
                _config.ReadInteger("Setup", "StartPermission", M2Share.g_Config.nStartPermission);
            ...
            M2Share.g_Config.nSendRefMsgRange =
                _config.ReadInteger("Setup", "SendRefMsgRange", M2Share.g_Config.nSendRefMsgRange);
            ...
            M2Share.g_Config.boHungerDecPower =
                _config.ReadBool("Setup", "HungerDecPower", M2Share.g_Config.boHungerDecPower);
            ...
            M2Share.g_Config.boDiableHumanRun =
                _config.ReadBool("Setup", "DiableHumanRun", M2Share.g_Config.boDiableHumanRun);
            ...
            M2Share.g_Config.boWarDisHumRun =
                _config.ReadBool("Setup", "WarDisableHumanRun", M2Share.g_Config.boWarDisHumRun);
            ...
            M2Share.g_Config.nSkeletonCount =
                _config.ReadInteger("Setup", "SkeletonCount", M2Share.g_Config.nSkeletonCount);
                ...
                I++)
            {
                ...
                M2Share.g_Config.SkeletonArray[I].nHumLevel = _config.ReadInteger("Setup", "SkeletonHumLevel" + I,
                ...
                M2Share.g_Config.SkeletonArray[I].sMonName = _config.ReadString("Names", "Skeleton" + I,
                ...
                M2Share.g_Config.SkeletonArray[I].nCount = _config.ReadInteger("Setup", "SkeletonCount" + I,
                ...
                M2Share.g_Config.SkeletonArray[I].nLevel = _config.ReadInteger("Setup", "SkeletonLevel" + I,
                ...
                I++)
            {
                ...
                M2Share.g_Config.DragonArray[I].nHumLevel = _config.ReadInteger("Setup", "DragonHumLevel" + I,
                ...
                M2Share.g_Config.DragonArray[I].sMonName =
                    _config.ReadString("Names", "Dragon" + I, M2Share.g_Config.DragonArray[I].sMonName);
                ...
                M2Share.g_Config.DragonArray[I].nCount = _config.ReadInteger("Setup", "DragonCount" + I,
                ...
                M2Share.g_Config.DragonArray[I].nLevel = _config.ReadInteger("Setup", "DragonLevel" + I,
            ...
            M2Share.g_Config.boCanNotGetBackDeal =
                _config.ReadBool("Setup", "CanNotGetBackDeal", M2Share.g_Config.boCanNotGetBackDeal);
            ...
            M2Share.g_Config.nMasterOKLevel =
                _config.ReadInteger("Setup", "MasterOKLevel", M2Share.g_Config.nMasterOKLevel);
            ...
            M2Share.g_Config.nMasterOKCreditPoint =
                _config.ReadInteger("Setup", "MasterOKCreditPoint", M2Share.g_Config.nMasterOKCreditPoint);
            ...
            M2Share.g_Config.nMasterOKBonusPoint =
                _config.ReadInteger("Setup", "MasterOKBonusPoint", M2Share.g_Config.nMasterOKBonusPoint);
            ...
            M2Share.g_Config.boPKLevelProtect =
                _config.ReadBool("Setup", "PKProtect", M2Share.g_Config.boPKLevelProtect);
            ...
            M2Share.g_Config.nPKProtectLevel =
                _config.ReadInteger("Setup", "PKProtectLevel", M2Share.g_Config.nPKProtectLevel);
            ...
            M2Share.g_Config.nRedPKProtectLevel =
                _config.ReadInteger("Setup", "RedPKProtectLevel", M2Share.g_Config.nRedPKProtectLevel);
            ...
            M2Share.g_Config.nItemPowerRate =
                _config.ReadInteger("Setup", "ItemPowerRate", M2Share.g_Config.nItemPowerRate);
            ...
            M2Share.g_Config.nScriptGotoCountLimit = _config.ReadInteger("Setup", "ScriptGotoCountLimit",
            ...
            M2Share.g_Config.btHearMsgFColor =
                _config.ReadInteger<byte>("Setup", "HearMsgFColor", M2Share.g_Config.btHearMsgFColor);
            ...
            M2Share.g_Config.btHearMsgBColor =
                _config.ReadInteger<byte>("Setup", "HearMsgBColor", M2Share.g_Config.btHearMsgBColor);
            ...
            M2Share.g_Config.btWhisperMsgFColor =
                _config.ReadInteger<byte>("Setup", "WhisperMsgFColor", M2Share.g_Config.btWhisperMsgFColor);
            ...
            M2Share.g_Config.btWhisperMsgBColor =
                _config.ReadInteger<byte>("Setup", "WhisperMsgBColor", M2Share.g_Config.btWhisperMsgBColor);
            ...
            M2Share.g_Config.btGMWhisperMsgFColor =
                _config.ReadInteger<byte>("Setup", "GMWhisperMsgFColor", M2Share.g_Config.btGMWhisperMsgFColor);
            ...
            M2Share.g_Config.btGMWhisperMsgBColor =
                _config.ReadInteger<byte>("Setup", "GMWhisperMsgBColor", M2Share.g_Config.btGMWhisperMsgBColor);
            ...
            M2Share.g_Config.btCryMsgFColor =
                _config.ReadInteger<byte>("Setup", "CryMsgFColor", M2Share.g_Config.btCryMsgFColor);
            ...
            M2Share.g_Config.btCryMsgBColor =
                _config.ReadInteger<byte>("Setup", "CryMsgBColor", M2Share.g_Config.btCryMsgBColor);
            ...
            M2Share.g_Config.btGreenMsgFColor =
                _config.ReadInteger<byte>("Setup", "GreenMsgFColor", M2Share.g_Config.btGreenMsgFColor);
            ...
            M2Share.g_Config.btGreenMsgBColor =
                _config.ReadInteger<byte>("Setup", "GreenMsgBColor", M2Share.g_Config.btGreenMsgBColor);
            ...
            M2Share.g_Config.btBlueMsgFColor =
                _config.ReadInteger<byte>("Setup", "BlueMsgFColor", M2Share.g_Config.btBlueMsgFColor);
            ...
            M2Share.g_Config.btBlueMsgBColor =
                _config.ReadInteger<byte>("Setup", "BlueMsgBColor", M2Share.g_Config.btBlueMsgBColor);
            ...
            M2Share.g_Config.btRedMsgFColor =
                _config.ReadInteger<byte>("Setup", "RedMsgFColor", M2Share.g_Config.btRedMsgFColor);
            ...
            M2Share.g_Config.btGuildMsgFColor =
                _config.ReadInteger<byte>("Setup", "GuildMsgFColor", M2Share.g_Config.btGuildMsgFColor);
            ...
            M2Share.g_Config.btGuildMsgBColor =
                _config.ReadInteger<byte>("Setup", "GuildMsgBColor", M2Share.g_Config.btGuildMsgBColor);
            ...
            M2Share.g_Config.btGroupMsgFColor =
                _config.ReadInteger<byte>("Setup", "GroupMsgFColor", M2Share.g_Config.btGroupMsgFColor);
            ...
            M2Share.g_Config.btGroupMsgBColor =
                _config.ReadInteger<byte>("Setup", "GroupMsgBColor", M2Share.g_Config.btGroupMsgBColor);
            ...
            M2Share.g_Config.btCustMsgFColor =
                _config.ReadInteger<byte>("Setup", "CustMsgFColor", M2Share.g_Config.btCustMsgFColor);
            ...
            M2Share.g_Config.btCustMsgBColor =
                _config.ReadInteger<byte>("Setup", "CustMsgBColor", M2Share.g_Config.btCustMsgBColor);
            ...
            M2Share.g_Config.nMonRandomAddValue =
                _config.ReadInteger("Setup", "MonRandomAddValue", M2Share.g_Config.nMonRandomAddValue);
            ...
            M2Share.g_Config.nMakeRandomAddValue =
                _config.ReadInteger("Setup", "MakeRandomAddValue", M2Share.g_Config.nMakeRandomAddValue);
            ...
            M2Share.g_Config.nWeaponDCAddValueMaxLimit = _config.ReadInteger("Setup", "WeaponDCAddValueMaxLimit",
            ...
            M2Share.g_Config.nWeaponDCAddValueRate = _config.ReadInteger("Setup", "WeaponDCAddValueRate",
            ...
            M2Share.g_Config.nWeaponMCAddValueMaxLimit = _config.ReadInteger("Setup", "WeaponMCAddValueMaxLimit",
            ...
            M2Share.g_Config.nWeaponMCAddValueRate = _config.ReadInteger("Setup", "WeaponMCAddValueRate",
            ...
            M2Share.g_Config.nWeaponSCAddValueMaxLimit = _config.ReadInteger("Setup", "WeaponSCAddValueMaxLimit",
            ...
            M2Share.g_Config.nWeaponSCAddValueRate = _config.ReadInteger("Setup", "WeaponSCAddValueRate",
            ...
            M2Share.g_Config.nDressDCAddValueMaxLimit = _config.ReadInteger("Setup", "DressDCAddValueMaxLimit",
            ...
            M2Share.g_Config.nDressDCAddValueRate =
                _config.ReadInteger("Setup", "DressDCAddValueRate", M2Share.g_Config.nDressDCAddValueRate);
            ...
            M2Share.g_Config.nDressDCAddRate =
                _config.ReadInteger("Setup", "DressDCAddRate", M2Share.g_Config.nDressDCAddRate);
            ...
            M2Share.g_Config.nDressMCAddValueMaxLimit = _config.ReadInteger("Setup", "DressMCAddValueMaxLimit",
            ...
            M2Share.g_Config.nDressMCAddValueRate =
                _config.ReadInteger("Setup", "DressMCAddValueRate", M2Share.g_Config.nDressMCAddValueRate);
            ...
            M2Share.g_Config.nDressMCAddRate =
                _config.ReadInteger("Setup", "DressMCAddRate", M2Share.g_Config.nDressMCAddRate);
            ...
            M2Share.g_Config.nDressSCAddValueMaxLimit = _config.ReadInteger("Setup", "DressSCAddValueMaxLimit",
            ...
            M2Share.g_Config.nDressSCAddValueRate =
                _config.ReadInteger("Setup", "DressSCAddValueRate", M2Share.g_Config.nDressSCAddValueRate);
            ...
            M2Share.g_Config.nDressSCAddRate =
                _config.ReadInteger("Setup", "DressSCAddRate", M2Share.g_Config.nDressSCAddRate);
            if (_config.ReadInteger("Setup", "NeckLace19DCAddValueMaxLimit", -1) < 0)
                _config.WriteInteger("Setup", "NeckLace19DCAddValueMaxLimit",
                    M2Share.g_Config.nNeckLace19DCAddValueMaxLimit);
            M2Share.g_Config.nNeckLace19DCAddValueMaxLimit = _config.ReadInteger("Setup", "NeckLace19DCAddValueMaxLimit",
                M2Share.g_Config.nNeckLace19DCAddValueMaxLimit);
            ...
            M2Share.g_Config.nNeckLace19DCAddValueRate = _config.ReadInteger("Setup", "NeckLace19DCAddValueRate",
            ...
            M2Share.g_Config.nNeckLace19DCAddRate =
                _config.ReadInteger("Setup", "NeckLace19DCAddRate", M2Share.g_Config.nNeckLace19DCAddRate);
            if (_config.ReadInteger("Setup", "NeckLace19MCAddValueMaxLimit", -1) < 0)
                _config.WriteInteger("Setup", "NeckLace19MCAddValueMaxLimit",
                    M2Share.g_Config.nNeckLace19MCAddValueMaxLimit);
            M2Share.g_Config.nNeckLace19MCAddValueMaxLimit = _config.ReadInteger("Setup", "NeckLace19MCAddValueMaxLimit",
                M2Share.g_Config.nNeckLace19MCAddValueMaxLimit);
            ...
            M2Share.g_Config.nNeckLace19MCAddValueRate = _config.ReadInteger("Setup", "NeckLace19MCAddValueRate",
            ...
            M2Share.g_Config.nNeckLace19MCAddRate =
                _config.ReadInteger("Setup", "NeckLace19MCAddRate", M2Share.g_Config.nNeckLace19MCAddRate);
            if (_config.ReadInteger("Setup", "NeckLace19SCAddValueMaxLimit", -1) < 0)
                _config.WriteInteger("Setup", "NeckLace19SCAddValueMaxLimit",
                    M2Share.g_Config.nNeckLace19SCAddValueMaxLimit);
            M2Share.g_Config.nNeckLace19SCAddValueMaxLimit = _config.ReadInteger("Setup", "NeckLace19SCAddValueMaxLimit",
                M2Share.g_Config.nNeckLace19SCAddValueMaxLimit);
            ...
            M2Share.g_Config.nNeckLace19SCAddValueRate = _config.ReadInteger("Setup", "NeckLace19SCAddValueRate",
            ...
            M2Share.g_Config.nNeckLace19SCAddRate =
                _config.ReadInteger("Setup", "NeckLace19SCAddRate", M2Share.g_Config.nNeckLace19SCAddRate);
            if (_config.ReadInteger("Setup", "NeckLace202124DCAddValueMaxLimit", -1) < 0)
                _config.WriteInteger("Setup", "NeckLace202124DCAddValueMaxLimit",
                    M2Share.g_Config.nNeckLace202124DCAddValueMaxLimit);
            M2Share.g_Config.nNeckLace202124DCAddValueMaxLimit = _config.ReadInteger("Setup",
            ...
            if (_config.ReadInteger("Setup", "NeckLace202124DCAddValueRate", -1) < 0)
                _config.WriteInteger("Setup", "NeckLace202124DCAddValueRate",
                    M2Share.g_Config.nNeckLace202124DCAddValueRate);
            M2Share.g_Config.nNeckLace202124DCAddValueRate = _config.ReadInteger("Setup", "NeckLace202124DCAddValueRate",
                M2Share.g_Config.nNeckLace202124DCAddValueRate);
            ...
            M2Share.g_Config.nNeckLace202124DCAddRate = _config.ReadInteger("Setup", "NeckLace202124DCAddRate",
                M2Share.g_Config.nNeckLace202124DCAddRate);
            if (_config.ReadInteger("Setup", "NeckLace202124MCAddValueMaxLimit", -1) < 0)
                _config.WriteInteger("Setup", "NeckLace202124MCAddValueMaxLimit",
                    M2Share.g_Config.nNeckLace202124MCAddValueMaxLimit);
            M2Share.g_Config.nNeckLace202124MCAddValueMaxLimit = _config.ReadInteger("Setup",
            ...
            if (_config.ReadInteger("Setup", "NeckLace202124MCAddValueRate", -1) < 0)
                _config.WriteInteger("Setup", "NeckLace202124MCAddValueRate",
                    M2Share.g_Config.nNeckLace202124MCAddValueRate);
            M2Share.g_Config.nNeckLace202124MCAddValueRate = _config.ReadInteger("Setup", "NeckLace202124MCAddValueRate",
                M2Share.g_Config.nNeckLace202124MCAddValueRate);
            ...
            M2Share.g_Config.nNeckLace202124MCAddRate = _config.ReadInteger("Setup", "NeckLace202124MCAddRate",
                M2Share.g_Config.nNeckLace202124MCAddRate);
            if (_config.ReadInteger("Setup", "NeckLace202124SCAddValueMaxLimit", -1) < 0)
                _config.WriteInteger("Setup", "NeckLace202124SCAddValueMaxLimit",
                    M2Share.g_Config.nNeckLace202124SCAddValueMaxLimit);
            M2Share.g_Config.nNeckLace202124SCAddValueMaxLimit = _config.ReadInteger("Setup",
            ...
            if (_config.ReadInteger("Setup", "NeckLace202124SCAddValueRate", -1) < 0)
                _config.WriteInteger("Setup", "NeckLace202124SCAddValueRate",
                    M2Share.g_Config.nNeckLace202124SCAddValueRate);
            M2Share.g_Config.nNeckLace202124SCAddValueRate = _config.ReadInteger("Setup", "NeckLace202124SCAddValueRate",
                M2Share.g_Config.nNeckLace202124SCAddValueRate);
            ...
            M2Share.g_Config.nNeckLace202124SCAddRate = _config.ReadInteger("Setup", "NeckLace202124SCAddRate",
                M2Share.g_Config.nNeckLace202124SCAddRate);
            if (_config.ReadInteger("Setup", "ArmRing26DCAddValueMaxLimit", -1) < 0)
                _config.WriteInteger("Setup", "ArmRing26DCAddValueMaxLimit",
                    M2Share.g_Config.nArmRing26DCAddValueMaxLimit);
            M2Share.g_Config.nArmRing26DCAddValueMaxLimit = _config.ReadInteger("Setup", "ArmRing26DCAddValueMaxLimit",
                M2Share.g_Config.nArmRing26DCAddValueMaxLimit);
            ...
            M2Share.g_Config.nArmRing26DCAddValueRate = _config.ReadInteger("Setup", "ArmRing26DCAddValueRate",
            ...
            M2Share.g_Config.nArmRing26DCAddRate =
                _config.ReadInteger("Setup", "ArmRing26DCAddRate", M2Share.g_Config.nArmRing26DCAddRate);
            if (_config.ReadInteger("Setup", "ArmRing26MCAddValueMaxLimit", -1) < 0)
                _config.WriteInteger("Setup", "ArmRing26MCAddValueMaxLimit",
                    M2Share.g_Config.nArmRing26MCAddValueMaxLimit);
            M2Share.g_Config.nArmRing26MCAddValueMaxLimit = _config.ReadInteger("Setup", "ArmRing26MCAddValueMaxLimit",
                M2Share.g_Config.nArmRing26MCAddValueMaxLimit);
            ...
            M2Share.g_Config.nArmRing26MCAddValueRate = _config.ReadInteger("Setup", "ArmRing26MCAddValueRate",
            ...
            M2Share.g_Config.nArmRing26MCAddRate =
                _config.ReadInteger("Setup", "ArmRing26MCAddRate", M2Share.g_Config.nArmRing26MCAddRate);
            if (_config.ReadInteger("Setup", "ArmRing26SCAddValueMaxLimit", -1) < 0)
                _config.WriteInteger("Setup", "ArmRing26SCAddValueMaxLimit",
                    M2Share.g_Config.nArmRing26SCAddValueMaxLimit);
            M2Share.g_Config.nArmRing26SCAddValueMaxLimit = _config.ReadInteger("Setup", "ArmRing26SCAddValueMaxLimit",
                M2Share.g_Config.nArmRing26SCAddValueMaxLimit);
            ...
            M2Share.g_Config.nArmRing26SCAddValueRate = _config.ReadInteger("Setup", "ArmRing26SCAddValueRate",
            ...
            M2Share.g_Config.nArmRing26SCAddRate =
                _config.ReadInteger("Setup", "ArmRing26SCAddRate", M2Share.g_Config.nArmRing26SCAddRate);
            ...
            M2Share.g_Config.nRing22DCAddValueMaxLimit = _config.ReadInteger("Setup", "Ring22DCAddValueMaxLimit",
            ...
            M2Share.g_Config.nRing22DCAddValueRate = _config.ReadInteger("Setup", "Ring22DCAddValueRate",
            ...
            M2Share.g_Config.nRing22DCAddRate =
                _config.ReadInteger("Setup", "Ring22DCAddRate", M2Share.g_Config.nRing22DCAddRate);
            ...
            M2Share.g_Config.nRing22MCAddValueMaxLimit = _config.ReadInteger("Setup", "Ring22MCAddValueMaxLimit",
            ...
            M2Share.g_Config.nRing22MCAddValueRate = _config.ReadInteger("Setup", "Ring22MCAddValueRate",
            ...
            M2Share.g_Config.nRing22MCAddRate =
                _config.ReadInteger("Setup", "Ring22MCAddRate", M2Share.g_Config.nRing22MCAddRate);
            ...
            M2Share.g_Config.nRing22SCAddValueMaxLimit = _config.ReadInteger("Setup", "Ring22SCAddValueMaxLimit",
            ...
            M2Share.g_Config.nRing22SCAddValueRate = _config.ReadInteger("Setup", "Ring22SCAddValueRate",
            ...
            M2Share.g_Config.nRing22SCAddRate =
                _config.ReadInteger("Setup", "Ring22SCAddRate", M2Share.g_Config.nRing22SCAddRate);
            ...
            M2Share.g_Config.nRing23DCAddValueMaxLimit = _config.ReadInteger("Setup", "Ring23DCAddValueMaxLimit",
            ...
            M2Share.g_Config.nRing23DCAddValueRate = _config.ReadInteger("Setup", "Ring23DCAddValueRate",
            ...
            M2Share.g_Config.nRing23DCAddRate =
                _config.ReadInteger("Setup", "Ring23DCAddRate", M2Share.g_Config.nRing23DCAddRate);
            ...
            M2Share.g_Config.nRing23MCAddValueMaxLimit = _config.ReadInteger("Setup", "Ring23MCAddValueMaxLimit",
            ...
            M2Share.g_Config.nRing23MCAddValueRate = _config.ReadInteger("Setup", "Ring23MCAddValueRate",
            ...
            M2Share.g_Config.nRing23MCAddRate =
                _config.ReadInteger("Setup", "Ring23MCAddRate", M2Share.g_Config.nRing23MCAddRate);
            ...
            M2Share.g_Config.nRing23SCAddValueMaxLimit = _config.ReadInteger("Setup", "Ring23SCAddValueMaxLimit",
            ...
            M2Share.g_Config.nRing23SCAddValueRate = _config.ReadInteger("Setup", "Ring23SCAddValueRate",
            ...
            M2Share.g_Config.nRing23SCAddRate =
                _config.ReadInteger("Setup", "Ring23SCAddRate", M2Share.g_Config.nRing23SCAddRate);
            ...
            M2Share.g_Config.nHelMetDCAddValueMaxLimit = _config.ReadInteger("Setup", "HelMetDCAddValueMaxLimit",
            ...
            M2Share.g_Config.nHelMetDCAddValueRate = _config.ReadInteger("Setup", "HelMetDCAddValueRate",
            ...
            M2Share.g_Config.nHelMetDCAddRate =
                _config.ReadInteger("Setup", "HelMetDCAddRate", M2Share.g_Config.nHelMetDCAddRate);
            ...
            M2Share.g_Config.nHelMetMCAddValueMaxLimit = _config.ReadInteger("Setup", "HelMetMCAddValueMaxLimit",
            ...
            M2Share.g_Config.nHelMetMCAddValueRate = _config.ReadInteger("Setup", "HelMetMCAddValueRate",
            ...
            M2Share.g_Config.nHelMetMCAddRate =
                _config.ReadInteger("Setup", "HelMetMCAddRate", M2Share.g_Config.nHelMetMCAddRate);
            ...
            M2Share.g_Config.nHelMetSCAddValueMaxLimit = _config.ReadInteger("Setup", "HelMetSCAddValueMaxLimit",
            ...
            M2Share.g_Config.nHelMetSCAddValueRate = _config.ReadInteger("Setup", "HelMetSCAddValueRate",
            ...
            M2Share.g_Config.nHelMetSCAddRate =
                _config.ReadInteger("Setup", "HelMetSCAddRate", M2Share.g_Config.nHelMetSCAddRate);
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowHelMetACAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowHelMetMACAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowHelMetDCAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowHelMetMCAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowHelMetSCAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowNecklaceACAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowNecklaceMACAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowNecklaceDCAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowNecklaceMCAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowNecklaceSCAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowRingACAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowRingMACAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowRingDCAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowRingMCAddValueMaxLimit",
            ...
            if (nLoadInteger < 0)
                _config.WriteInteger("Setup", "UnknowRingSCAddValueMaxLimit",
            ...
            M2Share.g_Config.nMakeMineHitRate =
                _config.ReadInteger("Setup", "MakeMineHitRate", M2Share.g_Config.nMakeMineHitRate);
            ...
            M2Share.g_Config.nMakeMineRate =
                _config.ReadInteger("Setup", "MakeMineRate", M2Share.g_Config.nMakeMineRate);
            ...
            M2Share.g_Config.nStoneTypeRate =
                _config.ReadInteger("Setup", "StoneTypeRate", M2Share.g_Config.nStoneTypeRate);
            ...
            M2Share.g_Config.nStoneTypeRateMin =
                _config.ReadInteger("Setup", "StoneTypeRateMin", M2Share.g_Config.nStoneTypeRateMin);
            ...
            M2Share.g_Config.nGoldStoneMin =
                _config.ReadInteger("Setup", "GoldStoneMin", M2Share.g_Config.nGoldStoneMin);
            ...
            M2Share.g_Config.nGoldStoneMax =
                _config.ReadInteger("Setup", "GoldStoneMax", M2Share.g_Config.nGoldStoneMax);
            ...
            M2Share.g_Config.nSilverStoneMin =
                _config.ReadInteger("Setup", "SilverStoneMin", M2Share.g_Config.nSilverStoneMin);
            ...
            M2Share.g_Config.nSilverStoneMax =
                _config.ReadInteger("Setup", "SilverStoneMax", M2Share.g_Config.nSilverStoneMax);
            ...
            M2Share.g_Config.nSteelStoneMin =
                _config.ReadInteger("Setup", "SteelStoneMin", M2Share.g_Config.nSteelStoneMin);
            ...
            M2Share.g_Config.nSteelStoneMax =
                _config.ReadInteger("Setup", "SteelStoneMax", M2Share.g_Config.nSteelStoneMax);
            ...
            M2Share.g_Config.nBlackStoneMin =
                _config.ReadInteger("Setup", "BlackStoneMin", M2Share.g_Config.nBlackStoneMin);
            ...
            M2Share.g_Config.nBlackStoneMax =
                _config.ReadInteger("Setup", "BlackStoneMax", M2Share.g_Config.nBlackStoneMax);
            ...
            M2Share.g_Config.nStoneMinDura =
                _config.ReadInteger("Setup", "StoneMinDura", M2Share.g_Config.nStoneMinDura);
            ...
            M2Share.g_Config.nStoneGeneralDuraRate = _config.ReadInteger("Setup", "StoneGeneralDuraRate",
            ...
            M2Share.g_Config.nStoneAddDuraRate =
                _config.ReadInteger("Setup", "StoneAddDuraRate", M2Share.g_Config.nStoneAddDuraRate);
            ...
            M2Share.g_Config.nStoneAddDuraMax =
                _config.ReadInteger("Setup", "StoneAddDuraMax", M2Share.g_Config.nStoneAddDuraMax);
            ...
            M2Share.g_Config.nWinLottery1Min =
                _config.ReadInteger("Setup", "WinLottery1Min", M2Share.g_Config.nWinLottery1Min);
            ...
            M2Share.g_Config.nWinLottery1Max =
                _config.ReadInteger("Setup", "WinLottery1Max", M2Share.g_Config.nWinLottery1Max);
            ...
            M2Share.g_Config.nWinLottery2Min =
                _config.ReadInteger("Setup", "WinLottery2Min", M2Share.g_Config.nWinLottery2Min);
            ...
            M2Share.g_Config.nWinLottery2Max =
                _config.ReadInteger("Setup", "WinLottery2Max", M2Share.g_Config.nWinLottery2Max);
            ...
            M2Share.g_Config.nWinLottery3Min =
                _config.ReadInteger("Setup", "WinLottery3Min", M2Share.g_Config.nWinLottery3Min);
            ...
            M2Share.g_Config.nWinLottery3Max =
                _config.ReadInteger("Setup", "WinLottery3Max", M2Share.g_Config.nWinLottery3Max);
            ...
            M2Share.g_Config.nWinLottery4Min =
                _config.ReadInteger("Setup", "WinLottery4Min", M2Share.g_Config.nWinLottery4Min);
            ...
            M2Share.g_Config.nWinLottery4Max =
                _config.ReadInteger("Setup", "WinLottery4Max", M2Share.g_Config.nWinLottery4Max);
            ...
            M2Share.g_Config.nWinLottery5Min =
                _config.ReadInteger("Setup", "WinLottery5Min", M2Share.g_Config.nWinLottery5Min);
            ...
            M2Share.g_Config.nWinLottery5Max =
                _config.ReadInteger("Setup", "WinLottery5Max", M2Share.g_Config.nWinLottery5Max);
            ...
            M2Share.g_Config.nWinLottery6Min =
                _config.ReadInteger("Setup", "WinLottery6Min", M2Share.g_Config.nWinLottery6Min);
            ...
            M2Share.g_Config.nWinLottery6Max =
                _config.ReadInteger("Setup", "WinLottery6Max", M2Share.g_Config.nWinLottery6Max);
            ...
            M2Share.g_Config.nWinLotteryRate =
                _config.ReadInteger("Setup", "WinLotteryRate", M2Share.g_Config.nWinLotteryRate);
            ...
            M2Share.g_Config.nWinLottery1Gold =
                _config.ReadInteger("Setup", "WinLottery1Gold", M2Share.g_Config.nWinLottery1Gold);
            ...
            M2Share.g_Config.nWinLottery2Gold =
                _config.ReadInteger("Setup", "WinLottery2Gold", M2Share.g_Config.nWinLottery2Gold);
            ...
            M2Share.g_Config.nWinLottery3Gold =
                _config.ReadInteger("Setup", "WinLottery3Gold", M2Share.g_Config.nWinLottery3Gold);
            ...
            M2Share.g_Config.nWinLottery4Gold =
                _config.ReadInteger("Setup", "WinLottery4Gold", M2Share.g_Config.nWinLottery4Gold);
            ...
            M2Share.g_Config.nWinLottery5Gold =
                _config.ReadInteger("Setup", "WinLottery5Gold", M2Share.g_Config.nWinLottery5Gold);
            ...
            M2Share.g_Config.nWinLottery6Gold =
                _config.ReadInteger("Setup", "WinLottery6Gold", M2Share.g_Config.nWinLottery6Gold);
            ...
            M2Share.g_Config.nGuildRecallTime =
                _config.ReadInteger("Setup", "GuildRecallTime", M2Share.g_Config.nGuildRecallTime);
            ...
            M2Share.g_Config.nGroupRecallTime =
                _config.ReadInteger("Setup", "GroupRecallTime", M2Share.g_Config.nGroupRecallTime);
            ...
            M2Share.g_Config.boControlDropItem =
                _config.ReadBool("Setup", "ControlDropItem", M2Share.g_Config.boControlDropItem);
            ...
            M2Share.g_Config.boInSafeDisableDrop =
                _config.ReadBool("Setup", "InSafeDisableDrop", M2Share.g_Config.boInSafeDisableDrop);
            ...
            M2Share.g_Config.nCanDropPrice =
                _config.ReadInteger("Setup", "CanDropPrice", M2Share.g_Config.nCanDropPrice);
            ...
            M2Share.g_Config.nSuperRepairPriceRate = _config.ReadInteger("Setup", "SuperRepairPriceRate",
            ...
            M2Share.g_Config.nRepairItemDecDura =
                _config.ReadInteger("Setup", "RepairItemDecDura", M2Share.g_Config.nRepairItemDecDura);
            ...
            M2Share.g_Config.boDieScatterBag =
                _config.ReadBool("Setup", "DieScatterBag", M2Share.g_Config.boDieScatterBag);
            ...
            M2Share.g_Config.nDieScatterBagRate =
                _config.ReadInteger("Setup", "DieScatterBagRate", M2Share.g_Config.nDieScatterBagRate);
            ...
            M2Share.g_Config.boDieRedScatterBagAll = _config.ReadBool("Setup", "DieRedScatterBagAll",
            ...
            M2Share.g_Config.nDieDropUseItemRate =
                _config.ReadInteger("Setup", "DieDropUseItemRate", M2Share.g_Config.nDieDropUseItemRate);
            ...
            M2Share.g_Config.nDieRedDropUseItemRate = _config.ReadInteger("Setup", "DieRedDropUseItemRate",
            ...
            M2Share.g_Config.boKillByHumanDropUseItem = _config.ReadBool("Setup", "KillByHumanDropUseItem",
            ...
            M2Share.g_Config.boKillByMonstDropUseItem = _config.ReadBool("Setup", "KillByMonstDropUseItem",
            ...
            M2Share.g_Config.boKickExpireHuman =
                _config.ReadBool("Setup", "KickExpireHuman", M2Share.g_Config.boKickExpireHuman);
            ...
            M2Share.g_Config.nGuildRankNameLen =
                _config.ReadInteger("Setup", "GuildRankNameLen", M2Share.g_Config.nGuildRankNameLen);
            ...
            M2Share.g_Config.nGuildNameLen =
                _config.ReadInteger("Setup", "GuildNameLen", M2Share.g_Config.nGuildNameLen);
            ...
            M2Share.g_Config.nGuildMemberMaxLimit =
                _config.ReadInteger("Setup", "GuildMemberMaxLimit", M2Share.g_Config.nGuildMemberMaxLimit);
            ...
            M2Share.g_Config.nAttackPosionRate =
                _config.ReadInteger("Setup", "AttackPosionRate", M2Share.g_Config.nAttackPosionRate);
            ...
            M2Share.g_Config.nAttackPosionTime =
                _config.ReadInteger("Setup", "AttackPosionTime", M2Share.g_Config.nAttackPosionTime);
            ...
            M2Share.g_Config.btPKFlagNameColor =
                _config.ReadInteger<byte>("Setup", "PKFlagNameColor", M2Share.g_Config.btPKFlagNameColor);
            ...
            M2Share.g_Config.btAllyAndGuildNameColor = _config.ReadInteger<byte>("Setup", "AllyAndGuildNameColor",
            ...
            M2Share.g_Config.btWarGuildNameColor =
                _config.ReadInteger<byte>("Setup", "WarGuildNameColor", M2Share.g_Config.btWarGuildNameColor);
            ...
            M2Share.g_Config.btInFreePKAreaNameColor = _config.ReadInteger<byte>("Setup", "InFreePKAreaNameColor",
            ...
            M2Share.g_Config.btPKLevel1NameColor =
                _config.ReadInteger<byte>("Setup", "PKLevel1NameColor", M2Share.g_Config.btPKLevel1NameColor);
            ...
            M2Share.g_Config.btPKLevel2NameColor =
                _config.ReadInteger<byte>("Setup", "PKLevel2NameColor", M2Share.g_Config.btPKLevel2NameColor);
            ...
            M2Share.g_Config.dwSpiritMutinyTime =
                _config.ReadInteger("Setup", "SpiritMutinyTime", M2Share.g_Config.dwSpiritMutinyTime);
            ...
            M2Share.g_Config.nSpiritPowerRate =
                _config.ReadInteger("Setup", "SpiritPowerRate", M2Share.g_Config.nSpiritPowerRate);
            ...
            M2Share.g_Config.boMasterDieMutiny =
                _config.ReadBool("Setup", "MasterDieMutiny", M2Share.g_Config.boMasterDieMutiny);
            ...
            M2Share.g_Config.nMasterDieMutinyRate =
                _config.ReadInteger("Setup", "MasterDieMutinyRate", M2Share.g_Config.nMasterDieMutinyRate);
            ...
            M2Share.g_Config.nMasterDieMutinyPower = _config.ReadInteger("Setup", "MasterDieMutinyPower",
            ...
            M2Share.g_Config.nMasterDieMutinySpeed = _config.ReadInteger("Setup", "MasterDieMutinyPower",
            ...
            M2Share.g_Config.boOldClientShowHiLevel = _config.ReadBool("Setup", "OldClientShowHiLevel",
            ...
            M2Share.g_Config.boShowScriptActionMsg = _config.ReadBool("Setup", "ShowScriptActionMsg",
            ...
            M2Share.g_Config.nRunSocketDieLoopLimit = _config.ReadInteger("Setup", "RunSocketDieLoopLimit",
            ...
            M2Share.g_Config.ClientConf.btDieColor =
                _config.ReadInteger<byte>("Setup", "DeathColorEffect", M2Share.g_Config.ClientConf.btDieColor);
            ...
            M2Share.g_Config.ClientConf.boParalyCanRun =
                _config.ReadBool("Setup", "ParalyCanRun", M2Share.g_Config.ClientConf.boParalyCanRun);
            ...
            M2Share.g_Config.ClientConf.boParalyCanWalk = _config.ReadBool("Setup", "ParalyCanWalk",
            ...
            M2Share.g_Config.ClientConf.boParalyCanHit =
                _config.ReadBool("Setup", "ParalyCanHit", M2Share.g_Config.ClientConf.boParalyCanHit);
            ...
            M2Share.g_Config.ClientConf.boParalyCanSpell = _config.ReadBool("Setup", "ParalyCanSpell",
            ...
            M2Share.g_Config.boShowExceptionMsg =
                _config.ReadBool("Setup", "ShowExceptionMsg", M2Share.g_Config.boShowExceptionMsg);
            ...
            M2Share.g_Config.boShowPreFixMsg =
                _config.ReadBool("Setup", "ShowPreFixMsg", M2Share.g_Config.boShowPreFixMsg);
            ...
            M2Share.g_Config.nMagTurnUndeadLevel =
                _config.ReadInteger("Setup", "MagTurnUndeadLevel", M2Share.g_Config.nMagTurnUndeadLevel);
            ...
            M2Share.g_Config.nElecBlizzardRange =
                _config.ReadInteger("Setup", "ElecBlizzardRange", M2Share.g_Config.nElecBlizzardRange);
            ...
            M2Share.g_Config.nHumanLevelDiffer =
                _config.ReadInteger("Setup", "HumanLevelDiffer", M2Share.g_Config.nHumanLevelDiffer);
            ...
            M2Share.g_Config.boKillHumanWinLevel =
                _config.ReadBool("Setup", "KillHumanWinLevel", M2Share.g_Config.boKillHumanWinLevel);
            ...
            M2Share.g_Config.boKilledLostLevel =
                _config.ReadBool("Setup", "KilledLostLevel", M2Share.g_Config.boKilledLostLevel);
            ...
            M2Share.g_Config.nKillHumanWinLevel = _config.ReadInteger("Setup", "KillHumanWinLevelPoint",
            ...
            M2Share.g_Config.nKilledLostLevel =
                _config.ReadInteger("Setup", "KilledLostLevelPoint", M2Share.g_Config.nKilledLostLevel);
            ...
            M2Share.g_Config.boKillHumanWinExp =
                _config.ReadBool("Setup", "KillHumanWinExp", M2Share.g_Config.boKillHumanWinExp);
            ...
            M2Share.g_Config.boKilledLostExp =
                _config.ReadBool("Setup", "KilledLostExp", M2Share.g_Config.boKilledLostExp);
            ...
            M2Share.g_Config.nKillHumanWinExp =
                _config.ReadInteger("Setup", "KillHumanWinExpPoint", M2Share.g_Config.nKillHumanWinExp);
            ...
            M2Share.g_Config.nKillHumanLostExp =
                _config.ReadInteger("Setup", "KillHumanLostExpPoint", M2Share.g_Config.nKillHumanLostExp);
            ...
            M2Share.g_Config.nMonsterPowerRate =
                _config.ReadInteger("Setup", "MonsterPowerRate", M2Share.g_Config.nMonsterPowerRate);
            ...
            M2Share.g_Config.nItemsPowerRate =
                _config.ReadInteger("Setup", "ItemsPowerRate", M2Share.g_Config.nItemsPowerRate);
            ...
            M2Share.g_Config.nItemsACPowerRate =
                _config.ReadInteger("Setup", "ItemsACPowerRate", M2Share.g_Config.nItemsACPowerRate);
            ...
            M2Share.g_Config.boSendOnlineCount =
                _config.ReadBool("Setup", "SendOnlineCount", M2Share.g_Config.boSendOnlineCount);
            ...
            M2Share.g_Config.nSendOnlineCountRate =
                _config.ReadInteger("Setup", "SendOnlineCountRate", M2Share.g_Config.nSendOnlineCountRate);
            ...
            M2Share.g_Config.dwSendOnlineTime =
                _config.ReadInteger("Setup", "SendOnlineTime", M2Share.g_Config.dwSendOnlineTime);
            ...
            M2Share.g_Config.dwSaveHumanRcdTime =
                _config.ReadInteger("Setup", "SaveHumanRcdTime", M2Share.g_Config.dwSaveHumanRcdTime);
            ...
            M2Share.g_Config.dwMakeGhostTime =
                _config.ReadInteger("Setup", "MakeGhostTime", M2Share.g_Config.dwMakeGhostTime);
            ...
            M2Share.g_Config.dwClearDropOnFloorItemTime = _config.ReadInteger("Setup", "ClearDropOnFloorItemTime",
            ...
            M2Share.g_Config.dwFloorItemCanPickUpTime = _config.ReadInteger("Setup", "FloorItemCanPickUpTime",
            ...
            M2Share.g_Config.boPasswordLockSystem =
                _config.ReadBool("Setup", "PasswordLockSystem", M2Share.g_Config.boPasswordLockSystem);
            ...
            M2Share.g_Config.boLockDealAction =
                _config.ReadBool("Setup", "PasswordLockDealAction", M2Share.g_Config.boLockDealAction);
            ...
            M2Share.g_Config.boLockDropAction =
                _config.ReadBool("Setup", "PasswordLockDropAction", M2Share.g_Config.boLockDropAction);
            ...
            M2Share.g_Config.boLockGetBackItemAction = _config.ReadBool("Setup", "PasswordLockGetBackItemAction",
            ...
            M2Share.g_Config.boLockHumanLogin =
                _config.ReadBool("Setup", "PasswordLockHumanLogin", M2Share.g_Config.boLockHumanLogin);
            ...
            M2Share.g_Config.boLockWalkAction =
                _config.ReadBool("Setup", "PasswordLockWalkAction", M2Share.g_Config.boLockWalkAction);
            ...
            M2Share.g_Config.boLockRunAction =
                _config.ReadBool("Setup", "PasswordLockRunAction", M2Share.g_Config.boLockRunAction);
            ...
            M2Share.g_Config.boLockHitAction =
                _config.ReadBool("Setup", "PasswordLockHitAction", M2Share.g_Config.boLockHitAction);
            ...
            M2Share.g_Config.boLockSpellAction =
                _config.ReadBool("Setup", "PasswordLockSpellAction", M2Share.g_Config.boLockSpellAction);
            ...
            M2Share.g_Config.boLockSendMsgAction = _config.ReadBool("Setup", "PasswordLockSendMsgAction",
            ...
            M2Share.g_Config.boLockUserItemAction = _config.ReadBool("Setup", "PasswordLockUserItemAction",
            ...
            M2Share.g_Config.boLockInObModeAction = _config.ReadBool("Setup", "PasswordLockInObModeAction",
            ...
            M2Share.g_Config.boPasswordErrorKick =
                _config.ReadBool("Setup", "PasswordErrorKick", M2Share.g_Config.boPasswordErrorKick);
            ...
            M2Share.g_Config.nPasswordErrorCountLock = _config.ReadInteger("Setup", "PasswordErrorCountLock",
            ...
            M2Share.g_Config.nSoftVersionDate =
                _config.ReadInteger("Setup", "SoftVersionDate", M2Share.g_Config.nSoftVersionDate);
            ...
            M2Share.g_Config.dwConsoleShowUserCountTime = _config.ReadInteger("Setup", "ConsoleShowUserCountTime",
            ...
            M2Share.g_Config.dwShowLineNoticeTime =
                _config.ReadInteger("Setup", "ShowLineNoticeTime", M2Share.g_Config.dwShowLineNoticeTime);
            ...
            M2Share.g_Config.nLineNoticeColor =
                _config.ReadInteger("Setup", "LineNoticeColor", M2Share.g_Config.nLineNoticeColor);
            ...
            M2Share.g_Config.ClientConf.btItemSpeed =
                _config.ReadInteger<byte>("Setup", "ItemSpeedTime", M2Share.g_Config.ClientConf.btItemSpeed);
            ...
            M2Share.g_Config.nMaxHitMsgCount =
                _config.ReadInteger("Setup", "MaxHitMsgCount", M2Share.g_Config.nMaxHitMsgCount);
            ...
            M2Share.g_Config.nMaxSpellMsgCount =
                _config.ReadInteger("Setup", "MaxSpellMsgCount", M2Share.g_Config.nMaxSpellMsgCount);
            ...
            M2Share.g_Config.nMaxRunMsgCount =
                _config.ReadInteger("Setup", "MaxRunMsgCount", M2Share.g_Config.nMaxRunMsgCount);
            ...
            M2Share.g_Config.nMaxWalkMsgCount =
                _config.ReadInteger("Setup", "MaxWalkMsgCount", M2Share.g_Config.nMaxWalkMsgCount);
            ...
            M2Share.g_Config.nMaxTurnMsgCount =
                _config.ReadInteger("Setup", "MaxTurnMsgCount", M2Share.g_Config.nMaxTurnMsgCount);
            ...
            M2Share.g_Config.nMaxSitDonwMsgCount =
                _config.ReadInteger("Setup", "MaxSitDonwMsgCount", M2Share.g_Config.nMaxSitDonwMsgCount);
            ...
            M2Share.g_Config.boActionSendActionMsg = _config.ReadBool("Setup", "ActionSendActionMsg",
            ...
            M2Share.g_Config.dwMagicHitIntervalTime = _config.ReadInteger("Setup", "MagicHitIntervalTime",
            ...
            M2Share.g_Config.dwRunIntervalTime =
                _config.ReadInteger("Setup", "RunIntervalTime", M2Share.g_Config.dwRunIntervalTime);
            ...
            M2Share.g_Config.dwWalkIntervalTime =
                _config.ReadInteger("Setup", "WalkIntervalTime", M2Share.g_Config.dwWalkIntervalTime);
            ...
            M2Share.g_Config.dwTurnIntervalTime =
                _config.ReadInteger("Setup", "TurnIntervalTime", M2Share.g_Config.dwTurnIntervalTime);
            ...
            M2Share.g_Config.HPStoneStartRate =
                _config.ReadInteger<byte>("Setup", "HPStoneStartRate", M2Share.g_Config.HPStoneStartRate);
            ...
            M2Share.g_Config.MPStoneStartRate =
                _config.ReadInteger<byte>("Setup", "MPStoneStartRate", M2Share.g_Config.MPStoneStartRate);
            ...
            M2Share.g_Config.HPStoneIntervalTime =
                _config.ReadInteger("Setup", "HPStoneIntervalTime", M2Share.g_Config.HPStoneIntervalTime);
            ...
            M2Share.g_Config.MPStoneIntervalTime =
                _config.ReadInteger("Setup", "MPStoneIntervalTime", M2Share.g_Config.MPStoneIntervalTime);
            ...
            M2Share.g_Config.HPStoneAddRate =
                _config.ReadInteger<byte>("Setup", "HPStoneAddRate", M2Share.g_Config.HPStoneAddRate);
            ...
            M2Share.g_Config.MPStoneAddRate =
                _config.ReadInteger<byte>("Setup", "MPStoneAddRate", M2Share.g_Config.MPStoneAddRate);
            ...
            M2Share.g_Config.HPStoneDecDura =
                _config.ReadInteger("Setup", "HPStoneDecDura", M2Share.g_Config.HPStoneDecDura);
            ...
            M2Share.g_Config.MPStoneDecDura =
                _config.ReadInteger("Setup", "MPStoneDecDura", M2Share.g_Config.MPStoneDecDura);
            // 气血石结束
            ...
            M2Share.g_Config.nStartCastleWarDays =
                _config.ReadInteger("Setup", "StartCastleWarDays", M2Share.g_Config.nStartCastleWarDays);
            ...
            M2Share.g_Config.nStartCastlewarTime =
                _config.ReadInteger("Setup", "StartCastlewarTime", M2Share.g_Config.nStartCastlewarTime);
            ...
            M2Share.g_Config.dwShowCastleWarEndMsgTime = _config.ReadInteger("Setup", "ShowCastleWarEndMsgTime",
            ...
            M2Share.g_Config.dwclickNpcTime =
                _config.ReadInteger("Server", "ClickNPCTime", M2Share.g_Config.dwclickNpcTime);
            ...
            M2Share.g_Config.dwCastleWarTime =
                _config.ReadInteger("Setup", "CastleWarTime", M2Share.g_Config.dwCastleWarTime);
        ...
        public void SaveVariable()
        {
            ...
            {
                _config.WriteInteger("Setup", "GlobalVal" + i, M2Share.g_Config.GlobalVal[i]);
            }
            _config.WriteInteger("Setup", "WinLotteryCount", M2Share.g_Config.nWinLotteryCount);
            _config.WriteInteger("Setup", "NoWinLotteryCount", M2Share.g_Config.nNoWinLotteryCount);
            _config.WriteInteger("Setup", "WinLotteryLevel1", M2Share.g_Config.nWinLotteryLevel1);
