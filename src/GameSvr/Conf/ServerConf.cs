...
namespace GameSvr.Conf
{
    public class ServerConf : ConfigFile
    {
        ...
        public void LoadConfig()
        {
            ...
            M2Share.Config.UnknowNecklaceACAddRate = ReadWriteInteger("Setup", "UnknowNecklaceACAddRate", M2Share.Config.UnknowNecklaceACAddRate);
            M2Share.Config.UnknowNecklaceACAddValueMaxLimit = ReadWriteInteger("Setup", "UnknowNecklaceACAddValueMaxLimit", M2Share.Config.UnknowNecklaceACAddValueMaxLimit);
            M2Share.Config.UnknowNecklaceMACAddRate = ReadWriteInteger("Setup", "UnknowNecklaceMACAddRate", -M2Share.Config.UnknowNecklaceMACAddRate);
            M2Share.Config.UnknowNecklaceMACAddValueMaxLimit = ReadWriteInteger("Setup", "UnknowNecklaceMACAddValueMaxLimit", M2Share.Config.UnknowNecklaceMACAddValueMaxLimit);
            M2Share.Config.UnknowNecklaceDCAddRate = ReadWriteInteger("Setup", "UnknowNecklaceDCAddRate", M2Share.Config.UnknowNecklaceDCAddRate);
            M2Share.Config.UnknowNecklaceDCAddValueMaxLimit = ReadWriteInteger("Setup", "UnknowNecklaceDCAddValueMaxLimit", M2Share.Config.UnknowNecklaceDCAddValueMaxLimit);
            M2Share.Config.UnknowNecklaceMCAddRate = ReadWriteInteger("Setup", "UnknowNecklaceMCAddRate", M2Share.Config.UnknowNecklaceMCAddRate);
            M2Share.Config.UnknowNecklaceMCAddValueMaxLimit = ReadWriteInteger("Setup", "UnknowNecklaceMCAddValueMaxLimit", M2Share.Config.UnknowNecklaceMCAddValueMaxLimit);
            M2Share.Config.UnknowNecklaceSCAddRate = ReadWriteInteger("Setup", "UnknowNecklaceSCAddRate", M2Share.Config.UnknowNecklaceSCAddRate);
            M2Share.Config.UnknowNecklaceSCAddValueMaxLimit = ReadWriteInteger("Setup", "UnknowNecklaceSCAddValueMaxLimit", M2Share.Config.UnknowNecklaceSCAddValueMaxLimit);
            M2Share.Config.UnknowRingACAddRate = ReadWriteInteger("Setup", "UnknowRingACAddRate", M2Share.Config.UnknowRingACAddRate);
            M2Share.Config.UnknowRingACAddValueMaxLimit = ReadWriteInteger("Setup", "UnknowRingACAddValueMaxLimit", M2Share.Config.UnknowRingACAddValueMaxLimit);
            M2Share.Config.UnknowRingMACAddRate = ReadWriteInteger("Setup", "UnknowRingMACAddRate", M2Share.Config.UnknowRingMACAddRate);
            M2Share.Config.UnknowRingMACAddValueMaxLimit = ReadWriteInteger("Setup", "UnknowRingMACAddValueMaxLimit", M2Share.Config.UnknowRingMACAddValueMaxLimit);
            M2Share.Config.UnknowRingDCAddRate = ReadWriteInteger("Setup", "UnknowRingDCAddRate", M2Share.Config.UnknowRingDCAddRate);
            M2Share.Config.UnknowRingDCAddValueMaxLimit = ReadWriteInteger("Setup", "UnknowRingDCAddValueMaxLimit", M2Share.Config.UnknowRingDCAddValueMaxLimit);
            M2Share.Config.UnknowRingMCAddRate = ReadWriteInteger("Setup", "UnknowRingMCAddRate", M2Share.Config.UnknowRingMCAddRate);
            M2Share.Config.UnknowRingMCAddValueMaxLimit = ReadWriteInteger("Setup", "UnknowRingMCAddValueMaxLimit", M2Share.Config.UnknowRingMCAddValueMaxLimit);
            M2Share.Config.UnknowRingSCAddRate = ReadWriteInteger("Setup", "UnknowRingSCAddRate", M2Share.Config.UnknowRingSCAddRate);
            M2Share.Config.UnknowRingSCAddValueMaxLimit = ReadWriteInteger("Setup", "UnknowRingSCAddValueMaxLimit", M2Share.Config.UnknowRingSCAddValueMaxLimit);
            ...
            M2Share.Config.MagicAttackRage = ReadWriteInteger("Setup", "MagicAttackRage", M2Share.Config.MagicAttackRage);
            M2Share.Config.DropItemRage = ReadWriteInteger("Setup", "DropItemRage", M2Share.Config.DropItemRage);
            ...
            M2Share.Config.FireBoomRage = ReadWriteInteger("Setup", "FireBoomRage", M2Share.Config.FireBoomRage);
            M2Share.Config.SnowWindRange = ReadWriteInteger("Setup", "SnowWindRange", M2Share.Config.SnowWindRange);
            ...
            M2Share.Config.ProcessMonsterMultiThreadLimit = ReadWriteInteger("Setup", "ProcessMonsterMultiThreadLimit", M2Share.Config.ProcessMonsterMultiThreadLimit);
