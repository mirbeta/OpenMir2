    ...
    public partial class RobotPlayObject
    {
        ...
        private bool TaoistAttackTarget()
        {
            ...
            try
            {
                ...
                if (m_nSelectMagic > 0)
                {
                    ...
                    if (UserMagic != null)
                    {
                        if (UserMagic.btKey == 0)   // 技能打开状态才能使用 
                        {
                            ...
                            if (TargetCret.m_WAbil.MaxHP >= 700 || !M2Share.Config.boHeroAttackTao)
                            {
                                return result;
                            }
                        }
                ...
                // 是否能躲避 
                // 增加人形条件
                if (M2Share.Config.boHeroAttackTarget && Abil.Level < 22 || TargetCret.m_WAbil.MaxHP < 700 && M2Share.Config.boHeroAttackTao && TargetCret.Race != Grobal2.RC_PLAYOBJECT)
                {
